...
const DATA: Record<Platform, Record<Mode, InstructionData>> = {
  airbnb: {
    ...
    import: {
      title: "How to import RentHome Departamentos into Airbnb",
      steps: [
        ...
        "Name it \"RentHome Departamentos Sync\" and click Import.",
      ],
    },
  },
  booking: {
    ...
    import: {
      title: "How to import RentHome Departamentos into Booking.com",
      steps: [
        ...
        "Name it \"RentHome Departamentos Sync\" and click Save.",
      ],
    },
  },
};
