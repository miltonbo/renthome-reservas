...
const DATA: Record<Platform, Record<Mode, InstructionData>> = {
  airbnb: {
    ...
    import: {
      title: "How to import DeptosBO into Airbnb",
      steps: [
        ...
        "Name it \"DeptosBO Sync\" and click Import.",
      ],
    },
  },
  booking: {
    ...
    import: {
      title: "How to import DeptosBO into Booking.com",
      steps: [
        ...
        "Name it \"DeptosBO Sync\" and click Save.",
      ],
    },
  },
};
