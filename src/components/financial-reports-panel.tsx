...
export function FinancialReportsPanel({ propertyId, properties }: { propertyId?: number | null; properties: Array<{ id: number; name: string }> }) {
  ...
  }, [selectedPeriod.from, selectedPeriod.to, reportPropertyId]);
