...
const COPY: Record<Locale, CopyShape> = {
  en: {
    ...
    body: (platform) =>
      `These nights were added directly in DeptosBO to the ${platform} reservation.`,
  ...
  ru: {
    ...
    body: (platform) =>
      `Эти ночи добавлены напрямую в DeptosBO к брони из ${platform}.`,
  ...
  de: {
    ...
    body: (platform) =>
      `Diese Nächte wurden in DeptosBO direkt zur ${platform}-Buchung hinzugefügt.`,
  ...
  fr: {
    ...
    body: (platform) =>
      `Ces nuits ont été ajoutées directement dans DeptosBO à la réservation ${platform}.`,
  ...
  es: {
    ...
    body: (platform) =>
      `Estas noches se añadieron directamente en DeptosBO a la reserva de ${platform}.`,
