...
const COPY: Record<Locale, CopyShape> = {
  ...
  ru: {
    ...
    heroTitle: "История изменений DeptosBO",
    heroIntro:
  ...
  de: {
    ...
    heroTitle: "DeptosBO-Änderungsverlauf",
    heroIntro:
  ...
  fr: {
    ...
    heroTitle: "Journal des modifications de DeptosBO",
    heroIntro:
  ...
  es: {
    ...
    heroTitle: "Registro de cambios de DeptosBO",
    heroIntro:
