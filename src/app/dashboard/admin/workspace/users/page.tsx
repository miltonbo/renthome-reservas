...
export default function AdminUsersPage() {
  ...
  const impersonate = async (id: number, username: string) => {
    if (!window.confirm(`View DeptosBO as ${username}? You'll see exactly what they see; click "Exit impersonation" in the top banner to return to your admin session.`)) {
      return;
    }
