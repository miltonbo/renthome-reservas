...
const PRIVACY_DESCRIPTION =
  "How DeptosBO collects, uses, stores, and protects your data — and how to access, export, or delete it.";
    ...
    <div className="editorial min-h-screen bg-[var(--bg)] text-[var(--ink)]">
      ...
      <main className="mx-auto max-w-3xl px-4 py-10 sm:px-6 sm:py-14">
        ...
        <div className="mt-8 space-y-8 text-sm leading-relaxed text-[var(--ink-2)] sm:text-base">
          <section>
            <p>
              This Privacy Policy describes how DeptosBO (&quot;the Service&quot;,
              ...
              use the Service, DeptosBO acts as the operator responsible
          ...
          <section>
            ...
            <p>
              When you upload guest passports to DeptosBO you remain the data controller
