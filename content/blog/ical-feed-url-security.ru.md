...
Во многом поэтому [RentHome Departamentos](/onboard) устроен именно так: тянет исходные фиды каждые 10 минут, отдаёт минимальный исходящий фид на объект и перевыпускает эту исходящую ссылку по требованию, не трогая настройки Airbnb и Booking.com. Разверните на дроплете за 4 $ или возьмите хостинговый инстанс — в обоих случаях токен, который вы вставляете в чужой софт, вы можете убить сами.
