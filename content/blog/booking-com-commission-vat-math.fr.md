...
locale: fr
title: "Commission Booking.com : le vrai taux après TVA et frais"
excerpt: Les 15 % affichés par Booking.com ne sont pas toute la facture. Ajoutez la TVA sur la commission et les frais de paiement : votre vrai taux frôle les 19 %.
status: published
tags:
...
- Les **15 % affichés sont un taux de base**, pas votre coût réel — la fourchette va de 10 à 25 % selon le pays et le type de logement.
- La commission porte sur le **total de la réservation** : la nuitée plus le ménage, les frais animaux et les frais voyageurs supplémentaires. Les taxes locales détaillées séparément en sont exclues.
- Si vous n'êtes **pas assujetti à la TVA**, Booking ajoute la **TVA locale sur la commission** — 19 % en Allemagne, 21 % en Espagne — un coût que vous ne récupérez pas.
- **Payments by Booking.com** ajoute par-dessus des frais de paiement de **1,1 à 3,1 %**, prélevés avant le versement.
- Tout cumulé, le vrai taux d'un hôte non assujetti en Europe tourne autour de **19 %**, pas 15 %.
- Genius et Preferred Partner se cumulent *par-dessus tout cela* — ils augmentent la part, ils ne la remplacent pas.
...
| Pays | Commission 15 % | TVA sur commission | Frais de paiement ~1,1 % | Booking garde | Il vous reste | Vrai taux |
| --- | --- | --- | --- | --- | --- | --- |
...
**[Genius](/blog/booking-com-genius-levels-math)** remise le prix que paie le *voyageur* — 10, 15 ou 20 %. La commission porte alors sur le montant inférieur, donc la commission diminue en valeur absolue, mais vous avez cédé plus de chiffre d'affaires que vous n'avez économisé en commission. Une réservation Genius Level 1 d'une nuit à 100 € devient une réservation à 90 € : commission 15 % × 90 € = 13,50 €, TVA et paiement sur la base réduite — mais vous avez encaissé 90 €, pas 100 €. Le coût, c'est la remise, pas la commission.

**[Preferred Partner](/blog/booking-com-preferred-partner-math)** fait l'inverse : vous payez environ **+2 % de commission** (17 % au lieu de 15 %) pour un coup de pouce au classement. Ces +2 % portent sur la base complète, et la TVA suit aussi sur la commission plus élevée. Pour un hôte espagnol non assujetti, Preferred fait passer le vrai taux de ~19,3 % à environ 21,6 %.
...
Additionnez les trois pour une réservation réelle et divisez par ce qu'a payé le voyageur. Ce pourcentage — pas les 15 % affichés — c'est ce que Booking vous coûte vraiment, et c'est le chiffre à utiliser quand vous comparez avec l'[exploitation d'un site de réservation directe](/blog/direct-booking-website-math) ou que vous pesez Booking face aux [frais Airbnb « hôte uniquement » contre frais partagés](/blog/airbnb-host-only-fee-vs-split-fee-math).
