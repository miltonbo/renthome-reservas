...
locale: de
title: "Puffertage richtig setzen: Schluss mit Back-to-Back-Reinigungschaos"
excerpt: Wie Kurzzeitvermieter die richtigen Puffertage finden. Der Umsatz-vs.-Qualität-Trade-off, die Mathematik und eine Pro-Objekt-Regel, die skaliert.
status: draft
tags:
  - cleaning:Reinigung
...
- Ein Puffertag ist eine leere Nacht, die Sie absichtlich nicht vermieten. Er kostet eine Verkaufsnacht pro Wechsel.
- Null Puffer funktioniert für Studios, die Sie in 90 Minuten oder weniger selbst reinigen. Größer kippt die Rechnung.
- Ein Puffertag ist die richtige Antwort für Familienvillen, Mehrzimmer-Wohnungen und alles mit externem Reinigungsteam.
- Zwei Puffertage sind Luxus, keine Strategie. Weglassen, außer das Objekt hat besondere Wechselbedürfnisse (Großgruppen-Aufräumen, Tiefenreinigung).
- Den Puffer einmal auf der kanonischen Plattform setzen, per iCal propagieren lassen. Nie auf beiden Plattformen manuell setzen.
...
Der [Beitrag zum Reinigungs-Modul](/blog/cleaning-schedule-automation) geht tiefer in den Reinigungs-Workflow. Die zwei Beiträge sind Buchstützen: dieser entscheidet, ob Sie einen Puffer brauchen; jener strukturiert die Arbeit, die hineinpasst.
...
**Airbnb.** Einstellung unter Inserate → Ihr Inserat → Verfügbarkeit → „Vorbereitungszeit". 1 Nacht vor, 1 Nacht nach oder beide wählen. Die meisten Hosts wollen nur „1 Nacht nach Auscheck". Das blockiert den Tag nach jedem Auscheck für neue Buchungen. Airbnbs [Hilfeartikel zur Vorbereitungszeit](https://www.airbnb.com/help/article/487) beschreibt die Mechanik.

**Booking.com.** Pendant im Extranet unter Unterkunft → Richtlinien → Hausregeln → Vor-Anreise-/Vorbereitungszeit, oder über eine Mindestlücken-Regel pro Zimmer. Bookings UI ist weniger offensichtlich; Bookings [Partner-Hub-Anleitung](https://partner.booking.com/en-gb/help) ist die kanonische Referenz, aber der genaue Pfad wandert mit jedem UI-Redesign.
