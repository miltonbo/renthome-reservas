...
locale: en
title: "Linen inventory for short-term rentals: how many sets per listing"
excerpt: How many sheet sets and towel sets you actually need per short-term rental — the laundry-cycle math, the dryer bottleneck, and what new hosts always get wrong.
status: published
tags:
  - cleaning:Cleaning
  - host-tips:Host tips
...
- The right floor is **three sheet sets per bed**, not two. One on the bed, one washing or in the dryer, one untouched in the closet for the no-good-very-bad day.
- The bottleneck is almost never the washer — it's **the dryer**. A queen fitted sheet takes 60–80 minutes to dry properly; a duvet cover takes 90+. Two beds plus duvet covers will keep one dryer busy for half a day.
- Towels are a separate count: **two bath towels and one hand towel per guest, plus one bath mat per bathroom, multiplied by 2.5 turnovers worth.** Not "per bed."
- Cotton sheets last roughly **80–120 wash cycles** at hotel-grade laundry temperatures. At 12 turnovers per month, that's a **replacement every 7–10 months per set**.
- Budget **$220–$320 per bed and $90–$140 per bathroom** for a starter linen kit you won't curse for the first 12 months.
...
| Item | Per stay | Inventory per listing (queen + 1 bathroom, 2 guests) |
|---|---|---|
| Bath towel | 2 per guest | 10 (2 × 2 × 2.5 turnovers) |
| Hand towel | 1 per guest | 5 |
| Face cloth / washcloth | 1 per guest | 5 |
| Bath mat | 1 per bathroom | 3 |
| Pool / beach towel (seasonal) | 1 per guest | 4 (only if listing advertises it) |
...
Internal cross-link: this is also the reason your [cleaning buffer days](/blog/cleaning-buffer-days) exist — when the same-day turnover math breaks, the buffer day is what saves the booking.
