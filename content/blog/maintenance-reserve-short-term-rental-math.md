...
locale: en
title: "Maintenance reserve for short-term rentals: the per-night number most hosts get wrong"
excerpt: Most hosts set aside 1–2% of gross for repairs. Real depreciation runs 5–8%. A worked spreadsheet of three breakdowns shows what the per-night reserve actually needs to be.
status: published
tags:
  - host-tips:Host tips
  - pricing:Pricing
...
- A **1–2% of gross** maintenance reserve is the number most hosts default to. It is too low for any unit older than three years.
- Real STR depreciation runs **5–8% of gross**, depending on age, climate, and turnover frequency.
- Per night, that is about **$4–$12 per night booked** on a unit grossing $150–$200 ADR.
- The reserve covers three buckets: **wear-out** (appliances aging), **break-in** (acute failures like leaks and floods), and **soft-cost** (cancelled nights while the unit is offline).
- A bookable unit that sat empty during a failure month also lost revenue — count it in the reserve.
- Hold the reserve in a **separate sub-account**, not the operating account. Otherwise you spend it.
- Refresh the rate annually after a 12-month look-back, not vibes.
...
**Turnover frequency.** A unit running 30 turnovers a month (mostly one-night bookings) wears at roughly 1.5× the rate of one running ten turnovers (mostly week-long stays). Minimum-night rules are not just about cleaning cost — they push the reserve number down too. The interaction with cleaning logistics is in [cleaning buffer days](/blog/cleaning-buffer-days).
