...
locale: fr
title: "Booking.com Preferred Partner : quand les +2 % de commission paient"
excerpt: Le calcul du badge Preferred Partner de Booking.com — la taxe de +2 % de commission, les deux paliers et pourquoi il ne rapporte qu'avec des nuits vides à remplir.
status: published
tags:
...
- Preferred Partner ajoute **~2 points de commission** (15 % → 17 %) pour un meilleur rang et un badge.
- **Preferred Plus** est le palier supérieur — plus de visibilité, **~3 pts+** de commission, règles plus strictes.
- Contrairement à Genius, la taxe frappe **tout** votre chiffre, pas une partie des réservations.
- Le seuil est bas : une hausse de **~3 %** du chiffre couvre les 2 points. Genius en demande ~12 %.
- Le piège : le badge ne booste les réservations que s'il y a des **nuits vides** à remplir.
- Au-dessus de **~85 % d'occupation**, c'est un cadeau de 2 points à Booking.com — désinscrivez-vous.
...
| Palier | Surcoût de commission | Ce que vous obtenez | Conditions |
|---|---|---|---|
| **Preferred** | +~2 pts (ex. 15 % → 17 %) | Badge, meilleur rang dans la recherche standard | Bonne note, peu d'annulations, prix compétitifs |
| **Preferred Plus** | +~3 pts ou plus | Poids de classement renforcé, badge distinct, placement en tête | Plus strict — note élevée, forte disponibilité, prix très compétitifs |
...
Les hôtes confondent Preferred et [Genius](/blog/booking-com-genius-levels-math) parce que les deux reviennent à « payer Booking.com plus pour de la visibilité ». Ce ne sont pas les mêmes leviers, et la différence décide vers lequel vous tourner.
...
Non. Il change seulement le taux de commission que Booking.com prélève. Votre calendrier de versement dépend de vos réglages de paiement, pas du programme — pour son fonctionnement, voyez [les délais de versement Booking.com](/blog/airbnb-booking-com-payout-timing).
