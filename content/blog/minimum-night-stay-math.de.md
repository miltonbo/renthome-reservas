...
locale: de
title: "Mindestnächte-Mathematik: wann 1, 2, 3 und 7 Nächte Geld bringen"
excerpt: Ab wann lohnt sich 1, 2, 3 oder 7 Nächte Mindestaufenthalt? Durchgerechnete Mathematik für Stadt-Studio, Strand-2-Zimmer und Berghütte — plus die Pro-LOS-Regler, die die meisten Hosts übersehen.
status: published
tags:
...
- Mindestnächte sind ein Kompromiss zwischen **Reinigungs-Stückkosten** und **ausgeschlossenen Buchungen** — es gibt keine universell richtige Zahl.
- Bei einem Stadt-Studio mit 25-$-Reinigung und hoher Wochentags-Nachfrage schlägt **1-Nacht-Minimum** das 2-Nacht-Minimum um ~20 $/Monat selbst nach Reinigungs-Mehrkosten.
- Bei einer 2-Zimmer mit 70-$-Reinigung und vor allem Wochenend-Nachfrage ist **2-Nacht-Minimum** die Untergrenze; 3 Nächte senkt Buchungen um 35–45 % für 15–25 $ ADR-Lift — meist ein Verlustgeschäft.
- Bei einer Hütte mit 150-$-Reinigung und vor allem Wochen-Nachfrage ist **3 Nächte Nebensaison, 7 Nächte Hauptsaison** Standard — Untergrenze, kein Startpunkt.
- Airbnb erlaubt **Pro-Aufenthaltslänge-Mindestnächte** für Wochentage, Wochenenden, Hauptsaison und die nächsten 7 Tage — die meisten Hosts berühren nur die globale Einstellung.
- Teuerster Fehler: Voreinstellung 2 Nächte, weil ein Forum es sagte, ohne den Markt auf Wochentags-1-Nacht-Nachfrage zu prüfen.
...
| Einstellung | LOS-Schnitt | Buchungen/Monat | Auslastung | Umsatz | Reinigung | **Netto** |
|---|---|---|---|---|---|---|
| 1 Nacht Min. | 1,8 | 13 | 75 % | 880 $ | 325 $ | **555 $** |
| 2 Nächte Min. | 2,6 | 9 | 65 % | 760 $ | 225 $ | **535 $** |
| 3 Nächte Min. | 3,1 | 6 | 55 % | 660 $ | 150 $ | **510 $** |
...
| Einstellung | LOS-Schnitt | Buchungen/Monat | Auslastung | Umsatz | Reinigung | **Netto** |
|---|---|---|---|---|---|---|
| 2 Nächte Min. | 3,1 | 8 | 80 % | 3.000 € | 560 € | **2.440 €** |
| 3 Nächte Min. | 3,9 | 5 | 65 % | 2.400 € | 350 € | **2.050 €** |
| 4 Nächte Min. | 4,6 | 4 | 55 % | 1.980 € | 280 € | **1.700 €** |
...
| Einstellung | LOS-Schnitt | Buchungen/Monat | Auslastung | Umsatz | Reinigung | **Netto** |
|---|---|---|---|---|---|---|
| 2 Nächte Min. | 4,2 | 5 | 70 % | 5.880 $ | 750 $ | **5.130 $** |
| 3 Nächte Min. | 5,5 | 4 | 70 % | 5.880 $ | 600 $ | **5.280 $** |
| 7 Nächte Min. (Hauptsaison) | 7,0 | 3 | 70 % | 5.880 $ | 450 $ | **5.430 $** |
...
Diesen Check fahre ich am 1. jeden Monats. Fünf Minuten pro Objekt. Meistens ändert sich nichts; ein- oder zweimal im Jahr verschiebt sich das Optimum eines Objekts, und die Änderung bringt 100–400 $. Mehr zu saisonalen Preis-Hebeln, die hierzu passen, in [Längen-Rabatt-Mathematik](/blog/length-of-stay-discount-math) und [Airbnb-Stornorichtlinien-Mathematik](/blog/airbnb-cancellation-policy-math).
