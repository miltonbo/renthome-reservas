...
locale: fr
title: "Niveaux Genius Booking.com : quand les remises 10, 15 et 20 % sont rentables"
excerpt: Le calcul des paliers Genius 1, 2 et 3 sur Booking.com. Le seuil de rentabilité par palier, la mécanique de visibilité du badge, et une règle par annonce.
status: published
tags:
...
- Genius est un **programme de fidélité voyageur, payé par les hôtes** — Booking attribue le badge aux voyageurs récurrents, et vous absorbez la remise.
- Trois paliers : Niveau 1 = 10 %, Niveau 2 = 15 %, Niveau 3 = 20 %. Chaque palier exige un minimum supérieur : 3, 10 et 30 réservations sur 24 mois.
- Le seuil de rentabilité du Niveau 1 demande environ **+12 % de réservations supplémentaires** qui n’existeraient pas sans le badge. La plupart des annonces obtiennent +4 à 8 %.
- Genius **se cumule de façon multiplicative** avec vos plans tarifaires longue durée et vos remises saisonnières. Un -20 % mensuel + -10 % Genius, c’est **-28 %**, pas -30 %.
- Au-delà de 80 % d’occupation, Genius est un poids mort ; sous 60 % sur une annonce non-Genius, il est généralement rentable. La zone médiane, c’est celle où l’on mesure.
- L’opt-in Genius est **toujours réversible**. Testez 60 jours, mesurez, décidez. Ne tranchez pas au jour zéro.
...
Pour creuser le calcul des remises longue durée, voir [le calcul des remises longue durée](/blog/length-of-stay-discount-math).
...
1. **Votre occupation a passé 85 %.** Vous n’avez plus besoin de la visibilité du badge. La remise est une pure baisse de salaire.
2. **Votre tarif moyen a monté de plus de 20 % sur le dernier trimestre.** Un ADR plus élevé veut dire que chaque réservation Genius coûte plus en valeur absolue. Le pourcentage de lift du badge est à peu près constant ; le coût grandit linéairement avec le tarif.
3. **Vous faites tourner un plan longue durée ou une promo saisonnière.** Le cumul s’aggrave. Coupez Genius ou coupez l’autre promo — laisser les deux tourner ensemble est le moyen le plus rapide de se réveiller à -30 % effectif un mardi creux de février.
...
Si vous êtes déjà sur Airbnb et Booking, le levier de visibilité de chaque plateforme compte moins parce que les voyageurs comparent en croisé. Voir [la synchro iCal gratuite](/blog/airbnb-booking-calendar-sync-free) comme prérequis pour faire tourner les deux sans doubles réservations.
