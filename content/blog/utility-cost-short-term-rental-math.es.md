...
locale: es
title: "Coste de suministros por noche en alquiler vacacional: el cálculo real"
excerpt: Lo que la electricidad, la calefacción, el agua e internet cuestan de verdad por noche reservada — el desglose en tres estaciones, y por qué el aire con la ventana abierta rompe el modelo.
status: published
tags:
...
- Los suministros cuestan **5–10 $ por noche ocupada** en un 1 dormitorio — casi nadie los imputa por reserva.
- Es un **coste híbrido**: internet es fijo por noche; calefacción y agua suben con la ocupación.
- El **impuesto al comportamiento del huésped** es real: un huésped no paga factura, así que no ahorra.
- Climatizar es la línea pivote: verano e invierno pueden **duplicar** el número.
- Internet parece barato hasta que baja la ocupación: 45 $/mes fijos cuestan más por noche reservada.
- Al año, un 1 dormitorio solo ronda **~1.500–1.800 $**; tres pisos, unos 4.800 $.
- Un termostato inteligente de 120 $ suele amortizarse en un solo verano.
...
| Línea de suministro | Entretiempo | Verano (aire) | Invierno (calef.) |
|---|---|---|---|
| Electricidad | 2,00 $ | 3,70 $ | 2,40 $ |
| Calefacción (gas) | — | — | 3,20 $ |
| Agua + alcantarillado | 0,60 $ | 0,70 $ | 0,55 $ |
| Internet (repartido) | 2,50 $ | 2,05 $ | 2,80 $ |
| Basuras | 0,35 $ | 0,35 $ | 0,35 $ |
