...
Si su objeto rueda por encima del 90 % de ocupación, deje de leer y vaya a subir su tarifa. No es un anfitrión estupendo con un objeto popular. Es un anfitrión barato, y el único que no se ha dado cuenta es usted. Siga el RevPAR durante tres meses, deje caer la ocupación hasta los setenta y muchos, y el número que importa subirá. Si quiere un único sitio que siga el RevPAR, la ocupación y el ADR de cada objeto sin exportar tres hojas de cálculo, para eso está [RentHome Departamentos](/onboard).
