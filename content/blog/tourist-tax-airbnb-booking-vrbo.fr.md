...
locale: fr
title: "Qui collecte la taxe de séjour sur Airbnb, Booking.com et Vrbo (2026)"
excerpt: "Carte pratique des marchés où Airbnb, Booking.com et Vrbo collectent et reversent eux-mêmes la taxe de séjour — et où ça reste à votre charge. Taux par ville US et par pays UE."
status: published
tags:
  - airbnb:Airbnb
...
- **Airbnb collecte et reverse lui-même dans environ 30 États américains, 150 villes et une liste croissante de pays UE** ; le reste reste à la charge de l'hôte.
- **Booking.com reverse lui-même dans moins de 25 juridictions au monde** ; par défaut, c'est « payable sur place » ou la taxe atterrit dans votre versement — *vous* déclarez et reversez.
- **La couverture de Vrbo aux États-Unis suit grosso modo celle d'Airbnb**, en Europe elle est inégale ; vérifiez la ligne « Lodging tax » dans le tableau de bord hôte, annonce par annonce.
- Le même bien peut être en mode « taxe reversée automatiquement » sur Airbnb et en mode « hôte reverse » sur Booking.com — les accords sont signés juridiction par juridiction, plateforme par plateforme.
- « Collectée » ne veut pas dire « reversée ». Dans environ 12 États américains, la plateforme collecte la taxe mais la verse à l'hôte avec une ligne au formulaire 1099 ; le reversement à la ville reste à votre charge.
- Pénalités en cas de non-reversement : **5 à 25 % de la taxe due plus intérêts** ; les manquements répétés en UE ajoutent **500 à 5 000 € fixes par trimestre** par-dessus.
- Tout hôte avec 3 biens ou plus, ou multi-plateforme, devrait faire une **réconciliation trimestrielle** : exporter le rapport fiscal de chaque plateforme, croiser avec le portail de l'administration locale, combler l'écart.
...
**États-Unis** — environ 30 États, soit via une loi marketplace facilitator d'État, soit via des accords ville par ville. La liste complète est sur la page d'aide [« Occupancy tax collection » d'Airbnb](https://www.airbnb.com/help/article/653) dans la section sur les juridictions. Les plus importantes :

| Juridiction | Taux | Reversé par Airbnb |
| --- | --- | --- |
| Californie (État) | 0 % État, 10–15 % cumulé typique par ville | Oui, dans ~100 villes |
| New York | 14,75 % cumulé (4 % sales + 5,875 % hotel + autres) | Oui |
| Floride (État) | 6 % sales + 0–6 % county tourist development | Oui dans 49 des 67 comtés |
| Texas (État) | 6 % hotel occupancy + surcharges locales | Oui dans ~80 villes |
| Hawaï | 10,25 % TAT + 3 % surcharge comté | Oui |
| Washington DC | 14,95 % sales | Oui |

**Union européenne et AELE** — couverture sur environ 35 pays et régions :

| Pays / région | Taux typique | Reversé par Airbnb |
| --- | --- | --- |
| Portugal (Lisbonne, Porto, Madère) | 2 € par voyageur par nuit, plafonné à 7 nuits | Oui |
| Espagne (Catalogne, Valence, Baléares) | 0,45–3,50 € par voyageur par nuit selon la région | Oui en Catalogne et à Valence ; partiel aux Baléares |
| France (la plupart des villes) | 1–5 % du prix par nuit, plafond € selon la classe | Oui |
| Italie (Rome, Florence, Milan, Venise) | 1–7 € par voyageur par nuit selon ville et type | Oui |
| Allemagne (Berlin, Hambourg, Munich) | 5 % du prix net à Berlin ; 3–5 € par nuit ailleurs | Oui dans ~40 villes |
| Pays-Bas (Amsterdam) | 12,5 % du prix par nuit | Oui |
| Grèce (national) | 0,50–10 € par nuit selon classe et saison | Oui |
...
- **Environ 12 villes et 4 États américains** — liste complète dans l'[aide partenaires Booking](https://partner.booking.com/en-us/help/legal-security/taxes-payments) sous « marketplace facilitator ».
...
**Airbnb.** Dans **Performance → Earnings → Transaction history**, sélectionnez la période et cliquez sur **Download CSV**. Le fichier contient une colonne `Withheld Tax`. Faites la somme sur la période. La ligne correspondante « Tax remitted » dans le récapitulatif fiscal annuel d'Airbnb indique si Airbnb a bien reversé à l'administration. Si les deux montants coïncident — vous êtes au clair. S'ils divergent, la plateforme a collecté mais *n'a pas* reversé : cet argent est dans votre versement et vous devez le déclarer vous-même. Le [guide des documents fiscaux Airbnb](https://www.airbnb.com/help/article/418) explique la terminologie, qui a changé deux fois en 2024–2025.
...
Pour le tableau opérationnel plus large dans lequel les lignes de taxe coexistent avec le reste, voyez [RGPD pour les hôtes de location courte durée](/blog/gdpr-for-vacation-rental-hosts) — le même rythme trimestriel convient à la protection des données.
