...
locale: fr
title: "Supplément voyageur Airbnb : la mathématique du tarif par personne"
excerpt: Ce qu'un voyageur supplémentaire coûte réellement par nuit, les trois modèles tarifaires utilisés par les hôtes et le tableau qui dit quand le supplément finance le linge plutôt que de faire fuir la réservation.
status: published
tags:
  - airbnb:Airbnb
...
- Un voyageur supplémentaire vous coûte **4 à 7 $ par nuit** : linge, serviettes, eau, électricité et 12 minutes de ménage en plus. Mesurez une fois, ensuite calculez à partir de ce plancher.
- La recommandation Airbnb de **10 à 15 $ par voyageur** sous-évalue de moitié la plupart des séjours à 4 voyageurs et plus.
- Un supplément égal ou supérieur à **(tarif de base ÷ nombre maximum de voyageurs)** couvre l'usure sans faire fuir les réservations à deux.
- Booking.com n'expose pas de champ supplément ; on traduit le même calcul en **plans tarifaires par occupation** avec un prix par tranche de 2, 3, 4, 5 et 6 voyageurs.
- Les hôtes qui désactivent le supplément constatent **3 à 7 % de réservations en plus** mais perdent **8 à 14 % de chiffre d'affaires** à occupation égale — le gain de conversion couvre rarement le manque à gagner sur l'usure.
...
| Poste de coût | Par voyageur par nuit | Note |
|---|---|---|
...
| Eau et assainissement | 0,70 $ | Tarif Lisbonne, une douche plus 4 chasses |
...
| Café/thé/sucre, réassort | 0,20 $ | Vrac, pas des capsules Nespresso |
| 12 minutes de ménage en plus | 0,95 $ | À 15 €/h pour la femme de ménage |
...
Indisponible directement dans l'interface Airbnb, reconstituable avec les [règles de prix intelligent](https://www.airbnb.com/help/article/2452) : suppléments distincts pour les voyageurs 3 à 4 et 5 à 6, ou supplément majoré le week-end.
...
| Configuration | Réservations (indice) | Écart |
|---|---|---|
| Tarif de base, sans supplément | 100,0 | référence |
| Base + 10 $/voyageur dès le 3e | 96,4 | –3,6 % |
| Base + 20 $/voyageur dès le 3e | 92,8 | –7,2 % |
...
| Configuration | Réservations | Voyageurs moy. | Brut | Renouvellement linge | Net hôte |
|---|---|---|---|---|---|
| Base 2, sans supplément | 138 | 3,6 | 35 420 $ | 890 $ | 34 530 $ |
| Base 2, 20 $/voyageur | 132 | 3,5 | 38 810 $ | 890 $ | 37 920 $ |
| Base 2, 30 $/voyageur | 124 | 3,4 | 39 150 $ | 890 $ | 38 260 $ |
| Booking.com par occupation | 134 | 3,5 | 38 150 $ | 890 $ | 37 260 $ |
...
Extranet Booking.com → **Tarifs et disponibilités** → **Gestion des plans tarifaires**. Créez un plan tarifaire par niveau d'occupation. Le réglage le plus répandu, c'est un pas net de 10 € :
