...
locale: es
title: "Coste de consumibles por estancia: la partida que todo anfitrión olvida"
excerpt: Lo que el papel higiénico, el café y el jabón cuestan de verdad en cada rotación de Airbnb — el desglose por estancia, las cuentas de granel frente a minorista, y tres escenarios de ocupación anualizados.
status: published
tags:
...
- Los consumibles cuestan **8–15 $ por rotación** en un 1 dormitorio — casi nadie los controla.
- Es un coste **por estancia, no por noche**: un huésped de 2 y de 7 noches gasta casi igual.
- Comprar a granel baja el precio unitario un **40–60 %** frente a una carrera de última hora.
- A 18 rotaciones al mes, 12 $ cada una son **~2.600 $ al año — por piso**.
- Los huéspedes pastan: el café y los artículos de aseo se los llevan enteros.
- El coste real es el armario vacío un viernes, no los consumibles en sí.
...
- **La ropa de cama y las toallas** son inventario duradero con una curva de desgaste, no un gasto por estancia. Se amortizan a lo largo de cientos de lavados, no de una estancia — es un cálculo del todo distinto, tratado en [el inventario de ropa de cama en alquiler vacacional](/blog/linen-inventory-short-term-rental).
- **Los productos de limpieza** — el espray, la escobilla del WC, las mopas — suelen ser de su limpiador y van incluidos en su tarifa por rotación. Si los pone usted, eso entra en la conversación de [cuánto pagar a su limpiador](/blog/cleaner-pay-short-term-rental), no en el presupuesto de consumibles.
- **El material pequeño** — bombillas, pilas, un nuevo limpiacristales de ducha — es mantenimiento y le toca estar en su [reserva de mantenimiento](/blog/maintenance-reserve-short-term-rental-math), no aquí. Es irregular, no en cada estancia.
...
| Partida | Consumo/stock por estancia | Precio mayorista unitario | Coste por estancia |
|---|---|---|---|
| Papel higiénico | ~2 rollos | 0,83 $/rollo | 1,66 $ |
| Jabón de manos (recarga) | parcial | 12 $/galón ÷ 8 recargas | 0,55 $ |
| Champú + acondicionador + gel | recargable | 18 $/galón combinado | 0,90 $ |
| Café | 4 cápsulas o una cuchara | 0,40 $/cápsula | 1,20 $ |
| Té | 3–4 bolsitas | 0,05 $/bolsita | 0,20 $ |
| Lavavajillas a mano | parcial | por estancia | 0,30 $ |
| Pastillas de lavavajillas | 2–3 | 0,18 $/unidad | 0,45 $ |
| Estropajo de cocina | 1 (reemplazado) | 0,40 $/unidad | 0,40 $ |
| Bolsas de basura | 2–3 | 0,15 $/bolsa | 0,40 $ |
| Papel de cocina | ~1 rollo | 0,80 $/rollo | 0,80 $ |
| Pañuelos de papel | parte de una caja | por estancia | 0,30 $ |
| Básicos de despensa (sal, aceite, azúcar) | trazas | amortizado | 0,35 $ |
| **Total** | | | **~7,95 $** |
...
Solo un 30 % de la partida, más o menos, escala con la duración de la estancia: el café de más que un huésped largo bebe al quinto día, los rollos de más que gasta una familia de una semana. Así que una estancia de 2 noches y una de 7 le cuestan casi lo mismo en consumibles — lo que significa que las estancias cortas son *caras por noche* en esta partida, igual que en la limpieza. Es exactamente el reparto por-estancia-frente-a-por-noche que fija su precio mínimo; el tratamiento completo está en [la tarifa mínima por noche](/blog/break-even-nightly-rate-math), y los consumibles son una de sus líneas.
...
| Partida | A granel por unidad | Minorista por unidad | Sobrecoste |
|---|---|---|---|
| Papel higiénico | 0,83 $/rollo | 1,25 $/rollo | +51 % |
| Cápsulas de café | 0,40 $/cápsula | 0,70 $/cápsula | +75 % |
| Jabón de manos | 0,55 $/recarga | 2,50 $/botella | +355 % |
| Bolsas de basura | 0,15 $/bolsa | 0,35 $/bolsa | +133 % |
...
Cuando el armario se vacía en plena rotación, alguien tiene que resolverlo antes de que llegue el huésped, y ese alguien es usted o su limpiador. Un limpiador que conduce al súper, compra lo que falta y trae el tique cobra un [recargo por desplazamiento de 25–45 $](/blog/cleaner-pay-short-term-rental) por encima de los productos a precio minorista. Hágalo dos veces en un mes y solo los recargos superan todo su presupuesto de consumibles a granel del piso. Si va usted, es una hora de su tiempo y medio depósito de gasolina para entregar un paquete de papel higiénico de 4 $. Los consumibles son baratos. Quedarse sin ellos no lo es.
...
| Perfil de ocupación | Rotaciones/mes | Por estancia | Al año (1 piso) | 3 pisos |
|---|---|---|---|---|
| Baja / estancias largas | 5 | 11 $ | 660 $ | 1.980 $ |
| 1 dormitorio estable | 12 | 11 $ | 1.584 $ | 4.752 $ |
| Estudio de alta rotación | 22 | 11 $ | 2.904 $ | 8.712 $ |
