...
locale: en
title: "Off-season math: close the listing or stay open?"
excerpt: Closing for the low season doesn't stop the insurance, the internet or the standing charges. The per-night contribution math on when staying open pays.
status: published
tags:
  - pricing:Pricing
  - host-tips:Host tips
...
- Closing doesn't stop your fixed costs. It only stops the revenue.
- The decision is per-night contribution margin, not monthly profit.
- A one-bed turnover costs about $66. Over 2 nights that's $42/night.
- Break-even ADR: $77 for a one-nighter, $19 for a 7-night stay.
- Raise the minimum stay in low season instead of closing the calendar.
- Check your insurance vacancy clause — many void after 30–60 days.
- A nights-per-year legal cap is the one case where closing clearly wins.
...
- Cleaner: $45–70 for a one-bed, more if they travel to you. See [what cleaners actually charge](/blog/cleaner-pay-short-term-rental).
- Laundry: about $3.50 in-house, $8–14 at a commercial service — the [full per-turnover breakdown](/blog/short-term-rental-laundry-cost-math).
- Consumables: $6–9 of coffee, paper, soap and the rest, per [cost per stay](/blog/consumables-cost-per-stay-math).
...
- Heating and hot water above the frost-protection baseline: $3–8 depending on climate and how badly the place is insulated. The [utility cost math](/blog/utility-cost-short-term-rental-math) has the per-night figures.
...
**Percentage — a slice of whatever you charge.** Airbnb host-only fees run about 3% and [split fee about 3% on your side](/blog/airbnb-host-only-fee-vs-split-fee-math). Booking.com takes 15–18%, before VAT on the commission in most of the EU.

And here is what is **not** a marginal cost, no matter how much it hurts to pay it: insurance, mortgage or rent, internet, utility standing charges, licence fees, depreciation, your dynamic-pricing subscription, and the [maintenance reserve](/blog/maintenance-reserve-short-term-rental-math) you fund monthly. Every one of those is identical whether the calendar is full or empty.
...
| Stay length | Marginal cost/night | Break-even ADR, Airbnb 3% | Break-even ADR, Booking.com 15% |
| --- | --- | --- | --- |
| 1 night | $75 | $77 | $88 |
| 2 nights | $42 | $43 | $49 |
| 3 nights | $31 | $32 | $36 |
...
So the low-season lever is the minimum stay, not the close button. Push the [minimum-night setting](/blog/minimum-night-stay-math) from 1 to 3 in your low months and most of the bookings that were losing you money simply stop arriving, without you giving up the ones that weren't.
...
| Metric | Coastal, November | Mountain, May | City, January |
| --- | --- | --- | --- |
| Achievable ADR | $65 | $70 | $95 |
| Occupancy | 22% | 12% | 58% |
| Nights sold | 7 | 3.6 | 17 |
| Average stay | 2.5 | 2.0 | 2.2 |
| Turnovers | 2.8 | 1.8 | 7.7 |
...
The mountain column is the interesting one. Sixty dollars a month is close enough to zero that other factors decide it: you're on call all month for the price of a tank of fuel, and one 3-star review in a quiet month costs you more than the $60, because [climbing a rating back](/blog/airbnb-rating-recovery-math) takes twenty-odd stays and you're only doing four. That's a legitimate place to close — a decision about risk and attention, not about cost.
...
| Line | Still billed while closed? | Typical monthly, 1-bed |
| --- | --- | --- |
| Mortgage or rent | Yes | $700–2,000 |
| Insurance premium | Yes | $85–125 |
| Internet | Yes — the lock and sensors need it | $40–60 |
| Utility standing charges | Yes | $25–45 |
| Frost-protection heating | Yes, and *only* while closed | $30–90 |
| Municipal licence / registration | Yes | $8–40 |
| Pricing and channel subscriptions | Only if you cancel them | $0–50 |
| Cleaning, laundry, consumables | No | $0 |
...
Then check your policy's **vacancy or unoccupancy clause** before you commit to a dark quarter. Most property policies suspend or narrow cover after 30 or 60 consecutive days without occupation, and the claim that gets denied under that clause is almost always the same one: a pipe that froze and split in week ten, discovered in week twelve. [Short-term rental policies vary a lot on this](/blog/short-term-rental-insurance-cost) — some accept a documented weekly inspection as continued occupancy, some don't. It is a five-minute phone call and it is the difference between a $400 repair and a $14,000 one.
