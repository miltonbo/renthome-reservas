...
locale: fr
title: "Formulaires pré-arrivée : quelles questions, quand envoyer, taux de complétion"
excerpt: Guide champ par champ des formulaires pré-arrivée pour hôtes en location courte durée. Quoi demander, quoi sauter, quand envoyer, et comment dépasser 90 % de complétion.
status: published
tags:
...
- Un formulaire pré-arrivée doit faire **5 à 7 champs**, pas 12. Chaque champ supplémentaire coupe la complétion d’environ 4 à 5 points.
- Envoyez-le **4 jours avant l’arrivée**, pas à la réservation. Les formulaires envoyés à la résa sont ignorés ; le voyageur pense voyage, pas paperasse.
- Demandez seulement ce que vous **utiliserez ce séjour**. Pièce et heure d’arrivée, oui. Préférence fumeur et régime alimentaire, non.
- Un seul rappel à J-1 fait passer la complétion de 60–65 % à 88–92 %. Deux rappels agacent plus qu’ils ne convertissent.
- Communiquez le code de la porte **uniquement après** l’envoi du formulaire. C’est le plus gros levier — le formulaire passe de corvée à clé.
...
Pour la mécanique des plateformes qui produit ces messages — comment Airbnb et Booking.com surfacent chat vs mail, intervalles, et où le lien va vraiment atterrir — voir [comment synchroniser ses calendriers Airbnb et Booking.com](/blog/airbnb-booking-calendar-sync-free).
...
Le tableau complet de ce que vous devez aux voyageurs côté données — l’information, la base légale, la durée, le processus de suppression — est dans un article séparé : [RGPD pour hôtes en location courte durée](/blog/gdpr-for-vacation-rental-hosts). Le formulaire pré-arrivée est le moment où la plupart des hôtes collectent pour la première fois des données personnelles ; traitez-le comme l’événement réglementé qu’il est.
