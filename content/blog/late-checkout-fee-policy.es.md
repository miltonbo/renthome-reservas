...
locale: es
title: "Política de salida tardía: cuánto cobrar y qué cobran de verdad los Anfitriones"
excerpt: Cuentas claras para tarifas de salida tardía en Airbnb, Booking.com y Vrbo. Por hora vs medio día, cuándo regalar la primera y el corte de llegada el mismo día.
status: published
tags:
...
- Una tarifa de salida tardía son dos cosas: un precio *y* un permiso. La mayoría solo le pone precio.
- Cobra **20–40 $ por hora pasadas las 11:00**, capado a media noche. Por encima, cobra la noche extra entera.
- **Regala los primeros 60 minutos** cuando el siguiente Huésped llega después de las 16:00 —ahorra una reseña Superhost más a menudo de lo que cuesta una hora del limpiador—.
- Si el siguiente Huésped llega el mismo día antes de las 14:00, la salida tardía **debe denegarse**. Ninguna tarifa cubre una rotación fallada.
- Una «salida tardía 50 $» escrita en las normas pero aplicada de forma inconsistente es peor que ninguna política. La inconsistencia es lo que aparece en las reseñas.
- Booking.com no cobra tarifas tardías por la plataforma —cobra vía Stripe, la herramienta «cargo extra» o efectivo—. No la presupuestes como ingreso garantizado.
...
1. **Horas extra del limpiador o slot perdido.** Si la rotación tarda 3 horas y la limpiadora cobra 20 $/h (o 60 $ plano), cada hora que el Huésped se queda pasadas las 11:00 o empuja a la limpiadora a su siguiente trabajo o comprime la rotación a una peor. Las limpiadoras lo notan. En tres meses de retrasos consistentes, o sube tarifa, o deja tu trabajo, o empieza a cortar esquinas. Ninguna es problema de 20 $.
2. **Riesgo de que el siguiente Huésped llegue a un piso medio limpio.** El fallo de segundo orden. La limpiadora va apurada por la salida tardía, se le pasa el espejo del baño, el siguiente Huésped ve marcas al check-in y escribe reseña. Cualquier Anfitrión que ha perdido el badge Superhost puede nombrar la semana exacta; en la mitad fue reacción en cadena de una salida tardía que debió denegar.
...
Si todavía no has cableado tu calendario para ver llegadas del mismo día de un vistazo, ese es el problema mayor. Una petición de salida tardía debería tomarte 90 segundos evaluar. Si te toma 10 minutos porque tienes que entrar a tres plataformas para ver quién llega, dirás sí cuando deberías decir no, o no cuando podías decir sí —y ambas son sangrías de ingreso—. (Para el lado calendario, [airbnb-booking-calendar-sync-free](/blog/airbnb-booking-calendar-sync-free) cubre la mecánica iCal; el lado buffer está en [cleaning-buffer-days](/blog/cleaning-buffer-days).)
