...
locale: de
title: "Airbnb-Aufpreis pro Gast: die Mathematik hinter dem Personenpreis"
excerpt: Was ein zusätzlicher Gast pro Nacht wirklich kostet, drei Preismodelle für Hosts und die Tabelle, die zeigt, wann der Aufpreis Ihre Wäschekosten deckt — und wann er die Buchung verscheucht.
status: published
tags:
  - airbnb:Airbnb
...
- Ein zusätzlicher Gast kostet Sie **4 bis 7 $ pro Nacht** an Wäsche, Handtüchern, Wasser, Strom und etwa 12 Minuten Mehraufwand bei der Reinigung — einmal messen, danach gegen diesen Boden kalkulieren.
- Die Airbnb-Vorgabe von **10 bis 15 $ pro Gast** unterbewertet die meisten Aufenthalte ab vier Gästen um die Hälfte.
- Ein Personenpreis ab **(Grundpreis pro Nacht ÷ maximale Gästezahl)** deckt den Verschleiß, ohne 2-Personen-Buchungen zu verscheuchen.
- Booking.com kennt kein eigenes Aufpreisfeld; die gleiche Rechnung läuft dort über **belegungsabhängige Tarifpläne** mit eigenen Preisen für 2, 3, 4, 5 und 6 Gäste.
- Hosts, die den Aufpreis abschalten, melden **3 bis 7 % mehr Buchungen**, verlieren aber **8 bis 14 % Umsatz** bei gleicher Belegung — der Konversionsgewinn deckt die Verschleißlücke fast nie.
...
| Kostenposition | Pro Gast pro Nacht | Anmerkung |
|---|---|---|
...
| Wasser und Abwasser | 0,70 $ | Tarif Lissabon, eine Dusche plus vier WC-Spülungen |
...
| Kaffee/Tee/Zucker, Nachfüllung | 0,20 $ | Großpackung, keine Nespresso-Kapseln |
| 12 Minuten Reinigungsverlängerung | 0,95 $ | Bei 15 €/h Reinigungskraft |
...
In der Airbnb-Oberfläche direkt nicht möglich, mit [Smart-Pricing-Regeln](https://www.airbnb.com/help/article/2452) aber nachstellbar: getrennte Aufpreise für Gäste 3 bis 4 gegenüber 5 bis 6 — oder ein höherer Aufpreis am Wochenende.
...
| Einstellung | Buchungen (indiziert) | Delta |
|---|---|---|
| Grundpreis, kein Aufpreis | 100,0 | Ausgangswert |
| Grundpreis + 10 $/Gast ab Gast 3 | 96,4 | –3,6 % |
| Grundpreis + 20 $/Gast ab Gast 3 | 92,8 | –7,2 % |
...
| Konfiguration | Buchungen | Ø Gäste | Brutto | Wäschetausch | Netto an Host |
|---|---|---|---|---|---|
| Basis 2, ohne Aufpreis | 138 | 3,6 | 35 420 $ | 890 $ | 34 530 $ |
| Basis 2, 20 $/Gast | 132 | 3,5 | 38 810 $ | 890 $ | 37 920 $ |
| Basis 2, 30 $/Gast | 124 | 3,4 | 39 150 $ | 890 $ | 38 260 $ |
| Booking.com belegungsabhängig | 134 | 3,5 | 38 150 $ | 890 $ | 37 260 $ |
...
Booking.com-Extranet → **Tarife und Verfügbarkeit** → **Verwaltung der Tarifpläne**. Legen Sie einen Tarifplan pro Belegung an. Die meisten Hosts wählen eine glatte 10-€-Stufe:
