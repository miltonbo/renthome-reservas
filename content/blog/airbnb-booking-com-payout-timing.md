...
locale: en
title: When do Airbnb and Booking.com actually pay you? Payout timing
excerpt: Airbnb pays ~24h after check-in; Booking.com pays weeks later. A worked timeline of when money really lands, the first-payout trap, and the cash-flow gap.
status: published
tags:
  - host-tips:Host tips
  - airbnb:Airbnb
...
- Airbnb releases a payout about **24 hours after the guest's scheduled check-in** — not the booking date.
- Once released, a bank transfer adds **1–3 business days**; an international wire adds 3–5.
- Booking.com pays on one of two models: a **virtual credit card** you charge yourself, or **Payments by Booking.com**.
- A virtual credit card has an **activation date** — you cannot charge it before check-in or checkout.
- Payments by Booking.com pays out **monthly**, often two to four weeks after the stay ends.
- Your **first-ever payout** is held longer for verification — don't budget on it.
- Plan for a **2–6 week gap** between "booked solid" and "money in the account".
...
This is the gap. It is not a bug and there is no setting that closes it. The fix is on your side: carry an operating buffer. For background on the other side of this ledger — the costs that fall due whether or not a payout has landed — see [cleaner pay for short-term rentals](/blog/cleaner-pay-short-term-rental).
...
If you want the gap mapped against your own calendar — which stays have released, which Booking.com cards are still chargeable, what lands this week — that is the kind of thing [RentHome Departamentos](/onboard) is built to surface. And if you are weighing whether a paid channel manager would smooth any of this, the honest math is in [channel manager break-even math](/blog/channel-manager-break-even-math).
