...
locale: es
title: "Noches huérfanas: los ingresos que su estancia mínima desperdicia"
excerpt: El cálculo de cuántas noches al año bloquea un mínimo de tres noches como huecos invendibles, y la excepción que abre solo esos huecos sin caos de una noche.
status: published
tags:
...
- Una **noche huérfana** es un hueco más corto que su estancia mínima — estructuralmente invendible.
- Un **mínimo de tres noches** vuelve invendible todo hueco de una o dos noches entre reservas.
- Una propiedad con ocupación media bloquea **~18–36 noches huérfanas al año**; ~10–20 son rellenables de verdad.
- A **150 $ por noche menos 60 $ de limpieza**, son **900–1800 $ por propiedad al año** de ingreso neto rechazado.
- La solución **no** es bajar el mínimo, sino una **excepción solo para huecos** en las fechas huérfanas, que no cuesta nada porque ya estaban vacías.
- Hacerlo a mano cada vez que aparece un hueco es por lo que los anfitriones lo dejan — **lo que hay que automatizar es la detección de huecos.**
...
| Hueco entre reservas | Duración | Estancia mínima = 3 | Estado |
|---|---|---|---|
| Reserva A → Reserva B | 2 noches | más corto que el mín. | Huérfano — muerto |
| Reserva B → Reserva C | 3 noches | cumple el mín. | Reservable |
| Reserva C → Reserva D | 1 noche | más corto que el mín. | Huérfano — muerto |
| Reserva D → Reserva E | 4 noches | cumple el mín. | Reservable |
...
| Estancia mínima | Duración de huecos huérfanos | Noches huérfanas/año (por propiedad) | Valor a 150 $ por noche |
|---|---|---|---|
| 2 noches | huecos de una noche | ~10 | 1500 $ |
| 3 noches | 1–2 noches | ~22 | 3300 $ |
| 4 noches | 1–3 noches | ~34 | 5100 $ |
| 5 noches | 1–4 noches | ~46 | 6900 $ |
