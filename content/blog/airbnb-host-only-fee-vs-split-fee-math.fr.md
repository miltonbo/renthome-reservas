...
locale: fr
title: "Airbnb : commission hôte seul vs commission partagée — les calculs"
excerpt: Quand les 15 % hôte seul battent les 3 % + 14 %, le gain de réservations réellement constaté, et le tableau chiffré pour un logement économique, intermédiaire et haut de gamme.
status: published
tags:
  - airbnb:Airbnb
...
- La **commission partagée par défaut** s'élève à environ **3 % côté hôte + 14,2 % côté voyageur** (entre 14 et 16 % selon le marché et la durée du séjour). La **commission « hôte seul »** est de **15 %** forfaitaires (16 % dans certains marchés), et le voyageur ne voit aucuns frais de service.
- Le prix affiché sur la fiche de recherche **baisse de 11 à 13 %** quand vous passez en hôte seul. Cela déclenche un gain de conversion mesurable : la plupart des hôtes constatent **8 à 18 % de réservations en plus** dans les 60 jours suivants.
- Votre versement net par nuit **baisse aussi de 11 à 13 %** dans le même mouvement. Le calcul est gagnant uniquement si le gain de réservations compense la perte de marge par réservation.
- Pour les logements **sous 100 $ la nuit** dans un environnement très concurrentiel sur le prix, l'hôte seul gagne presque toujours. Pour le **haut de gamme au-dessus de 300 $ la nuit** — là où le voyageur a déjà accepté que c'est cher — la commission partagée gagne généralement : l'effet conversion est plus faible en valeur absolue.
- **L'Italie, l'Espagne, la France, l'Argentine, Taïwan et l'Uruguay** rendent l'hôte seul obligatoire. Si votre annonce y est enregistrée, l'interrupteur est bloqué en position activée. Vérifiez la [page d'aide Airbnb sur les frais de service](https://www.airbnb.com/help/article/1857) — la liste évolue.
...
| Ligne | Partagée | Hôte seul |
|---|---|---|
| Sous-total des nuits | 200 $ | 200 $ |
| Frais de ménage | 50 $ | 50 $ |
| Frais de service Airbnb voyageur | +35,50 $ | 0 $ |
| **Total voyageur** | **285,50 $** | **250 $** |
| Frais de service Airbnb hôte | −6 $ (3 % de 200 $) | −30 $ (15 % de 200 $) |
| Ménage reversé à l'hôte | 50 $ | 50 $ |
| **Versement net hôte** | **244 $** | **220 $** |
...
| Réglage | Réservations/mois | Net par réservation | Net mensuel |
|---|---|---|---|
| Partagée (3 % hôte) | 11,0 | 145,50 $ | 1 600 $ |
| Hôte seul (15 % hôte) | 13,0 | 127,50 $ | 1 657 $ |
...
| Réglage | Réservations/mois | Net par réservation | Net mensuel |
|---|---|---|---|
| Partagée (3 % hôte) | 9,0 | 465,50 $ | 4 189 $ |
| Hôte seul (15 % hôte) | 10,0 | 408 $ | 4 080 $ |
...
| Réglage | Réservations/mois | Net par réservation | Net mensuel |
|---|---|---|---|
| Partagée (3 % hôte) | 4,0 | 1 710 $ | 6 840 $ |
| Hôte seul (15 % hôte) | 4,2 | 1 514 $ | 6 359 $ |
