...
locale: en
title: "Short-term rental insurance: what AirCover doesn't cover"
excerpt: AirCover and damage deposits aren't insurance. What a real short-term rental policy covers — property, liability, lost income — and what it costs per year.
status: published
tags:
  - host-tips:Host tips
  - airbnb:Airbnb
...
- **AirCover is not insurance.** It's a conditional, Airbnb-only reimbursement that pays for *guest-caused* damage, after depreciation, if you file within 14 days.
- A standard homeowner or landlord policy almost always **voids the moment you take paying guests** — a "business use" or "transient occupancy" exclusion most hosts never read.
- A real short-term rental policy covers five layers AirCover doesn't touch: **non-guest damage, all-channel liability, loss of rental income, the building itself, and your own belongings**.
- Typical annual premium for one unit: **$1,200–$3,000 in the US, £300–£800 in the UK, €300–€900 in the EU** — often less than one uncovered claim.
- The gap that bankrupts hosts isn't damage — it's **loss of income and a liability lawsuit**, neither of which AirCover reliably pays.
- Keep AirCover as a free backstop. Do **not** run it as your only cover.
...
The liability limb is the one exception worth naming: Airbnb's "Host liability insurance" up to $1M *is* underwritten insurance, not just a reimbursement. But it's still Airbnb-only, still a backstop with its own exclusions, and it evaporates the second a guest arrives through any other channel. For the full mechanics of the damage side and how it stacks against Booking.com and Vrbo, I wrote a whole post: [AirCover vs Booking.com damage deposit](/blog/airbnb-aircover-vs-booking-damage-deposit). This post is about the layer underneath all of it — the policy AirCover was never meant to replace.
...
| Coverage layer | What it pays for | AirCover | Proper STR policy |
| --- | --- | --- | --- |
| Building / structure | Fire, storm, water, subsidence — guest-caused or not | Guest-caused only, depreciated | All insured perils |
| Contents | Furniture, appliances, linens, electronics | Guest-caused only, depreciated | All insured perils |
| Public liability | Guest or third-party injury, lawsuit, legal defence | $1M, Airbnb bookings only | $1M–$2M+, every channel |
| Loss of rental income | Bookings you can't take while the unit is unrentable | Not covered | Covered (rider) |
| Host's own belongings | Valuables you keep on-site, owner's contents | Limited | Covered (rider) |

The two rows hosts underrate are liability and loss of income, so take them in turn.

**Liability is the one that can end you.** A guest slips on wet stairs and fractures a wrist. A child gets into an unfenced pool. Someone claims food poisoning. In the US, a bodily-injury suit routinely runs into six figures once medical costs and legal defence are added. AirCover's $1M liability covers this on an Airbnb stay — but the same guest on a Booking.com or direct booking has no host liability cover at all, because Booking.com provides none and your voided homeowner policy won't step in. Your own policy's liability limb covers the injury regardless of which platform sent the guest. If you have a pool or a hot tub, carry $2M, not $1M — the [hot-tub ROI math](/blog/hot-tub-roi-short-term-rental-math) looks very different once the liability premium is in it.
...
| Market | Typical annual premium (one unit) | Liability limit | Example specialist insurers |
| --- | --- | --- | --- |
| US | $1,200–$3,000 | $1M–$2M | Proper, Steadily, Obie, Foremost |
| UK | £300–£800 | £2M–£5M | Pikl, Guardhog, Schofields |
...
Set against a single uncovered event, the premium is small. A $2,000-a-year US policy is roughly $167 a month — less than most hosts spend on consumables and linen. Weigh it the same way you'd weigh a [maintenance reserve](/blog/maintenance-reserve-short-term-rental-math): it's not a cost, it's the price of not being wiped out by one bad Tuesday.
...
| Scenario | AirCover pays | Proper STR policy pays |
| --- | --- | --- |
| Faulty wiring starts a fire between stays (no guest present) | $0 — not guest-caused | Building + contents, minus deductible |
| Guest-caused kitchen fire blocks the calendar 6 weeks | Repair only (depreciated) | Repair + ~$5,000 lost income |
| Booking.com guest slips, fractures wrist, sues for $80k | $0 — AirCover is Airbnb-only | Legal defence + settlement to policy limit |
