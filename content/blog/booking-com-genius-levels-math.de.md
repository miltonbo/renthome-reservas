...
locale: de
title: "Booking.com Genius-Stufen: ab wann sich 10, 15 und 20 % lohnen"
excerpt: Durchgerechnete Mathematik zu Booking.coms Genius 1, 2 und 3. Der Mehr-Buchungen-Break-even pro Stufe, die Sichtbarkeitsrechnung hinter dem Badge und eine Pro-Listing-Regel.
status: published
tags:
...
- Genius ist ein **Treueprogramm für Gäste, finanziert von Hosts** — Booking vergibt das Badge an Stammbucher, Sie zahlen den Rabatt.
- Drei Stufen: Stufe 1 = 10 %, Stufe 2 = 15 %, Stufe 3 = 20 %. Jede Stufe verlangt mehr Mindestbuchungen: 3, 10 und 30 in 24 Monaten.
- Break-even bei der 10%-Stufe liegt bei rund **+12 % zusätzliche Buchungen**, die ohne Badge nicht existieren würden. Die meisten Listings holen +4–8 %.
- Genius **stapelt sich multiplikativ** mit Längen-Rabatten und Saisonrabatten. 20 % monatlich + 10 % Genius sind **28 % Rabatt**, nicht 30 %.
- Über 80 % Auslastung ist Genius totes Gewicht; unter 60 % auf einem Nicht-Genius-Listing zahlt es sich meist aus. Das Mittelband ist der Messbereich.
- Der Genius-Opt-in lässt sich **immer wieder verlassen**. 60 Tage testen, messen, entscheiden. Nicht am Tag null entscheiden.
...
| Stufe | Rabatt, den Sie geben | Buchungen nötig (rollende 24 Monate) | Zusatz-Vorteile |
|---|---|---|---|
| Genius Stufe 1 | 10 % | 3 | Genius-Badge, höher in Genius-Suchen |
| Genius Stufe 2 | 15 % | 10 | Frühstück oder Zimmer-Upgrade gratis (Wahl), priorisierter Support |
| Genius Stufe 3 | 20 % | 30 | Flughafentransfer-Slot oder Extra, Top-Ranking-Gewicht |
...
Vertiefung zur Längen-Rabatt-Mathematik selbst: [Längen-Rabatt-Mathematik](/blog/length-of-stay-discount-math).
...
Wer ohnehin auf Airbnb und Booking läuft, bei dem zählt der Sichtbarkeitshebel auf jeder Plattform weniger, weil Gäste plattformübergreifend vergleichen. Das [kostenlose iCal-Setup](/blog/airbnb-booking-calendar-sync-free) ist die Voraussetzung, beides ohne Doppelbuchungen zu fahren.
