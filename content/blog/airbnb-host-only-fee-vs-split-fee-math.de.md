...
locale: de
title: "Airbnb: Host-only-Gebühr vs. geteilte Gebühr — die Mathematik"
excerpt: Wann 15 % Host-only günstiger sind als 3 % + 14 %, welchen Buchungszuwachs Gastgeber tatsächlich sehen, und die Rechnung für günstige, mittlere und Premium-Objekte.
status: published
tags:
  - airbnb:Airbnb
  - pricing:Preise
...
- Die **geteilte Standardgebühr** liegt bei ungefähr **3 % vom Gastgeber + 14,2 % vom Gast** (Spannweite 14–16 % je nach Markt und Aufenthaltslänge). Die **Host-only-Gebühr** ist eine pauschale **15 %** (in manchen Märkten 16 %), und der Gast sieht keine separate Airbnb-Servicegebühr.
- Der Preis, den der Gast auf der Suchkachel sieht, **sinkt beim Wechsel auf Host-only um 11–13 %**. Das löst einen messbaren Conversion-Lift aus — die meisten Gastgeber sehen in den folgenden 60 Tagen **8–18 % mehr Buchungen**.
- Ihre Nettoauszahlung pro Nacht **sinkt im selben Schritt um 11–13 %**. Die Rechnung geht nur auf, wenn der Buchungszuwachs den Margenverlust pro Buchung überkompensiert.
- Für Objekte **unter 100 $ pro Nacht** mit hoher Preis-Konkurrenz gewinnt Host-only fast immer. Für **Premium-Objekte über 300 $ pro Nacht**, wo der Gast „teuer" längst akzeptiert hat, gewinnt meist das geteilte Modell — der Conversion-Vorteil ist absolut gesehen kleiner.
- **Italien, Spanien, Frankreich, Argentinien, Taiwan und Uruguay** sind Pflicht-Märkte für Host-only. Ist Ihr Inserat dort registriert, ist der Schalter fest aktiviert. Prüfen Sie den Stand in der [Airbnb-Hilfe zu Servicegebühren](https://www.airbnb.com/help/article/1857), bevor Sie eine freie Wahl annehmen.
...
1. **Aktualisieren Sie Ihren Grundpreis nach dem Wechsel.** Wenn Ihre Konkurrenzanalyse auf Preisen im geteilten Modell beruhte, fällt Ihre Kachel mit dem sofortigen 13-Prozent-Rückgang in eine Preisklasse, in der Sie nie sein wollten. Vergleichen Sie Objekte auf Ihren Daten und justieren Sie den Grundpreis in den ersten 7 Tagen nach.
