...
locale: en
title: "Booking.com Preferred Partner math: when the +2% commission pays back"
excerpt: Worked break-even on Booking.com's Preferred Partner badge — the +2% commission tax, the two-tier ladder, and why it only pays with empty nights to fill.
status: published
tags:
  - host-tips:Host tips
...
- Preferred Partner adds **~2pp to commission** (15% → 17%) for a ranking boost plus a badge.
- **Preferred Plus** is the higher tier — more visibility, **~3pp+** commission, stricter rules.
- Unlike Genius, the cost is a tax on your **entire** revenue, not a subset of bookings.
- Break-even is low: a **~3% lift** in revenue covers the 2pp. Genius needs ~12%.
- The catch: the badge only lifts bookings if you have **empty nights to fill**.
- Above **~85% occupancy** it's a flat 2pp donation to Booking.com — opt out.
...
| Tier | Commission delta | What you get | Eligibility |
|---|---|---|---|
| **Preferred** | +~2pp (e.g. 15% → 17%) | Thumbs-up badge, higher rank in standard search | Solid review score, low cancellations, competitive rates |
| **Preferred Plus** | +~3pp or more | Stronger ranking weight, distinct badge, top-of-results placement | Stricter — high score, high availability, aggressively competitive pricing |
...
Hosts conflate Preferred with [Genius](/blog/booking-com-genius-levels-math) because both are "pay Booking.com more for visibility." They are not the same lever, and the difference decides which one you should reach for.
...
No. It only changes the commission rate Booking.com deducts. Your payout schedule is governed by your payout settings, not the programme — see [Booking.com payout timing](/blog/airbnb-booking-com-payout-timing) for how that actually works.
