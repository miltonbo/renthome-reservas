...
locale: fr
title: "Minimum de nuits : quand 1, 2, 3 ou 7 nuits font vraiment gagner"
excerpt: Quand un minimum de 1, 2, 3 ou 7 nuits rapporte. Le calcul pour un studio urbain, un T2 en bord de mer et un chalet de montagne — plus les leviers par durée que la plupart ratent.
status: published
tags:
...
- Le minimum de nuits est un arbitrage entre **coût unitaire du ménage** et **réservations exclues** — pas de bon nombre universel.
- Pour un studio urbain à 25 $ de ménage et forte demande de semaine, **1 nuit minimum** bat le 2 nuits d’~20 $/mois après le coût ménage.
- Pour un T2 à 70 $ de ménage avec demande surtout week-end, **2 nuits minimum** est le plancher ; le 3 nuits chute les réservations de 35 à 45 % pour ~15–25 $ d’ADR — habituellement perdant.
- Pour un chalet à 150 $ de ménage avec demande surtout hebdo, **3 nuits hors saison, 7 nuits en pleine saison** est le standard — le plancher, pas un point de départ.
- Airbnb permet des **minimums par durée** pour semaine, week-end, haute saison, et les 7 prochains jours — la plupart des hôtes ne touchent que le réglage global.
- L’erreur la plus chère : 2 nuits par défaut parce qu’un forum l’a dit, sans vérifier la demande de semaine 1 nuit dans votre marché.
...
| Réglage | LOS moy | Réservations/mois | Occupation | Revenu | Ménage | **Net** |
|---|---|---|---|---|---|---|
| 1 nuit minimum | 1,8 | 13 | 75 % | 880 $ | 325 $ | **555 $** |
| 2 nuits minimum | 2,6 | 9 | 65 % | 760 $ | 225 $ | **535 $** |
| 3 nuits minimum | 3,1 | 6 | 55 % | 660 $ | 150 $ | **510 $** |
...
| Réglage | LOS moy | Réservations/mois | Occupation | Revenu | Ménage | **Net** |
|---|---|---|---|---|---|---|
| 2 nuits minimum | 3,1 | 8 | 80 % | 3 000 € | 560 € | **2 440 €** |
| 3 nuits minimum | 3,9 | 5 | 65 % | 2 400 € | 350 € | **2 050 €** |
| 4 nuits minimum | 4,6 | 4 | 55 % | 1 980 € | 280 € | **1 700 €** |
...
| Réglage | LOS moy | Réservations/mois | Occupation | Revenu | Ménage | **Net** |
|---|---|---|---|---|---|---|
| 2 nuits minimum | 4,2 | 5 | 70 % | 5 880 $ | 750 $ | **5 130 $** |
| 3 nuits minimum | 5,5 | 4 | 70 % | 5 880 $ | 600 $ | **5 280 $** |
| 7 nuits minimum (haute saison) | 7,0 | 3 | 70 % | 5 880 $ | 450 $ | **5 430 $** |
...
Je fais ce check le 1er de chaque mois. Cinq minutes par bien. La plupart des mois rien ne change ; une ou deux fois par an l’optimum d’un bien bouge et le changement vaut 100–400 $. Pour les leviers saisonniers qui se couplent, voir [le calcul des remises longue durée](/blog/length-of-stay-discount-math) et [le calcul des annulations Airbnb](/blog/airbnb-cancellation-policy-math).
