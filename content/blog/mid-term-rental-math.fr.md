...
locale: fr
title: "Location moyenne durée : quand 28 nuits battent la nuitée"
excerpt: Un mois calculé de deux façons — six ménages contre une seule réservation de 28 nuits. Le seuil à ~77 % d'occupation et le piège juridique que la plupart ignorent.
status: published
tags:
...
- Une réservation à partir de 28 nuits échange **le potentiel de revenu contre le calme opérationnel** : un ménage, zéro nuit vide, un voyageur pour tout le mois.
- Calculée honnêtement, une réservation de 30 nuits à 25 % de remise mensuelle a **battu la nuitée de ~97 $** sur un logement à 75 % d'occupation — parce que 100 % à 75 $ la nuit dépasse 75 % à 100 $.
- Le seuil de rentabilité est d'environ **77 % d'occupation nuitée.** En dessous, la moyenne durée gagne sur l'argent *et* le travail ; au-dessus, la nuitée passe devant en trésorerie, mais coûte 5 à 6 fois plus de ménages.
- Airbnb traite **28 nuits** comme le seuil long séjour — autre politique d'annulation, versement mensuel, aucune inspection par séjour.
- Dans une grande partie des États-Unis, un voyageur atteint des droits de locataire à **30 jours consécutifs** ; dans l'UE, la frontière entre location saisonnière et bail d'habitation est encore plus mince. Sélectionnez et contractualisez en conséquence.
...
1. **Gardez un ménage, ajoutez un passage à mi-parcours.** 30 nuits n'exigent pas de ménage hebdomadaire, mais une seule visite au jour 14 — linge frais, réapprovisionnement, un regard posé — attrape les dégâts et rappelle discrètement que c'est une location gérée, pas une résidence.
