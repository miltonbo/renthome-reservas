...
locale: de
title: "Airbnb-Auszahlung: die versteckte 3-%-Wechselkursgebühr"
excerpt: Preis in einer Währung, Konto in einer anderen? Airbnb und Booking.com bauen ~3 % in jede Auszahlung mit Umrechnung ein. Die echte Rechnung — und wie Sie sie stoppen.
status: published
tags:
  - airbnb:Airbnb
...
- Der Airbnb-Auszahlungskurs liegt ~3 % unter dem Interbankenkurs, wenn die Währungen abweichen.
- Die Gebühr steckt im Kurs — keine Zeile, kein Beleg, jahrelang übersehbar.
- Bei 30.000 € Auszahlungen pro Jahr sind das rund 900 € für nichts.
- Günstigste Lösung: Preis und Auszahlung in *derselben* Währung — keine Umrechnung.
- Geht nicht? In der Inseratswährung via Wise empfangen (~0,5 %), selbst tauschen.
- Booking.com versteckt denselben Spread in Virtual Cards und seinen Auszahlungen.
...
| Gastgeber | Preiswährung | Auszahlungswährung | Auszahlungen/Jahr | Verlust durch Spread/Jahr |
| --- | --- | --- | --- | --- |
| Küstenwohnung, Preis in EUR, UK-Bank | EUR | GBP | 30.000 € | ~900 € |
| Stadt-Studio, Preis in USD, EU-Bank | USD | EUR | 45.000 $ | ~1.350 $ |
| Zwei Einheiten, Preis in USD, lokale Bank | USD | UZS | 18.000 $ | ~560 $ (oft mehr) |
...
Damit Sie sehen, wie sich das mit den *anderen* unsichtbaren Abflüssen einer Auszahlung stapelt: Der Zeitpunkt des Geldes zählt so viel wie der Kurs — dazu der Beitrag [Auszahlungstiming bei Airbnb und Booking.com](/blog/airbnb-booking-com-payout-timing), die Liquiditätsseite desselben Auszugs.
...
| Wer rechnet um | Aufschlag auf den Interbankenkurs | Anmerkungen |
| --- | --- | --- |
| Airbnb / die Plattform | ~3 % (2,5–4 %+) | Im Kurs versteckt, keine Aufschlüsselung, keine Zeitwahl |
| Ihre lokale Bank | 2–4 % | Stark schwankend; fragen Sie den Kurs, bevor Sie zustimmen |
| Payoneer | ~2 % | Günstiger als die Plattform, nicht so scharf wie Wise |
| Wise | ~0,4–0,6 % + kleine Fixgebühr | Interbankenkurs plus transparent ausgewiesene Gebühr |
