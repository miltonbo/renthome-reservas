...
locale: de
title: "Booking.com-Provision: der echte Anteil nach MwSt. und Gebühren"
excerpt: Die genannten 15% von Booking.com sind nicht die ganze Rechnung. Mit MwSt. auf die Provision und der Zahlungsgebühr liegt Ihr echter Anteil näher bei 19%.
status: published
tags:
...
- Die genannten **15% sind ein Basissatz**, nicht Ihre echten Kosten — die Spanne reicht je nach Land und Unterkunftstyp von 10–25%.
- Die Provision wird auf die **gesamte Buchungssumme** berechnet: Übernachtung plus Reinigung, Haustier- und Zusatzgastgebühr. Separat ausgewiesene lokale Steuern sind ausgenommen.
- Sind Sie **nicht umsatzsteuerlich registriert**, schlägt Booking die **lokale MwSt. auf die Provision** auf — 19% in Deutschland, 21% in Spanien — als Kosten, die Sie nicht erstattet bekommen.
- **Payments by Booking.com** kommt obendrauf mit **1,1–3,1%** Zahlungsgebühr, vor der Auszahlung abgezogen.
- Alles zusammen ist der echte Anteil eines nicht registrierten Hosts in der EU rund **19%**, nicht 15%.
- Genius und Preferred Partner stapeln sich *auf all das* — sie erhöhen den Anteil, sie ersetzen ihn nicht.
...
| Land | Provision 15% | MwSt. auf Provision | Zahlungsgebühr ~1,1% | Booking behält | Ihnen bleibt | Echter Anteil |
| --- | --- | --- | --- | --- | --- | --- |
...
Sie zahlen Provision auf das, was Sie tatsächlich einnehmen. Eine voll erstattete Stornierung erzeugt keine Provision; eine Stornogebühr oder ein berechnetes No-Show schon, auf dem berechneten Betrag. Wie Sie bei einem No-Show Geld hereinholen und wann die Buchung greift, steht im [No-Show-Gebühren-Überblick](/blog/booking-com-no-show-fee).
