...
locale: es
title: "Provisión de mantenimiento en alquiler vacacional: la cifra por noche que casi todo anfitrión calcula mal"
excerpt: La mayoría de anfitriones reserva un 1–2 % de la facturación para reparaciones. El desgaste real es del 5–8 %. Tres averías reales muestran cuánto debe apartar por noche.
status: published
tags:
...
- **El 1–2 % de la facturación** es la cifra a la que llega por defecto la mayoría de anfitriones. Para cualquier vivienda con más de tres años, es poco.
- El desgaste real en un alquiler vacacional es del **5–8 % de la facturación**, según edad, clima y rotación.
- Por noche son aproximadamente **4–12 $ por noche reservada** sobre un ADR de 150–200 $.
- La provisión cubre tres cajones: **desgaste programado** (los equipos envejecen), **avería súbita** (fugas, compresor) y **lucro cesante** (noches que se cancelan mientras la vivienda está fuera de servicio).
- Un piso parado durante un mes de avería también es dinero perdido — debe entrar en la provisión.
- Mantenga la provisión en una **subcuenta separada**, no en la cuenta operativa. De lo contrario se la come.
- Revise la tasa cada año con un repaso real de doce meses, no de oído.
...
| Partida | Vida útil (vacacional) | Coste de reposición (gama media) | Anualizado |
| --- | --- | --- | --- |
| Colchón (queen) | 4–5 años | 700 $ | 150 $ |
| Sofá | 5–6 años | 1.200 $ | 215 $ |
| Frigorífico | 8–10 años | 900 $ | 100 $ |
| Lavavajillas | 6–8 años | 650 $ | 95 $ |
| Lavadora + secadora | 8–10 años | 1.400 $ | 155 $ |
| Aire acondicionado (sistema completo) | 12–15 años | 5.500 $ | 410 $ |
| Termo / calentador | 8–10 años | 1.100 $ | 120 $ |
| Ropa de cama (juego completo ×2) | 2 años | 400 $ | 200 $ |
| Toallas (juego ×3) | 2 años | 250 $ | 125 $ |
| Cazuelas, vajilla, copas | 3 años | 400 $ | 135 $ |
| Retoques + repintado | 3–4 años | 900 $ | 260 $ |
| Total anualizado | | | **1.965 $/año** |
...
| Cajón | Provisión anual (vivienda con 40K $) | % de la facturación |
| --- | --- | --- |
...
| ADR | Noches/año | Provisión al 8 % | Provisión por noche |
| --- | --- | --- | --- |
| 120 $ | 200 | 1.920 $ | 9,60 $ |
| 150 $ | 220 | 3.300 $ | 15,00 $ |
| 180 $ | 220 | 3.960 $ | 18,00 $ |
...
El seguro cubre siniestros y responsabilidad civil: incendio, daños por agua, lesión al huésped, robo. No cubre el desgaste programado (equipos que envejecen) ni la mayoría de fallos operativos (compresor muerto, fuga del termo). Provisión y seguro cubren categorías distintas. Las dos son necesarias; una no sustituye a la otra. La cobertura de plataforma tipo AirCover o la fianza de Booking.com cubre daños del huésped, y aún menos del desgaste — detalles en [Airbnb AirCover frente a fianza de Booking.com](/blog/airbnb-aircover-vs-booking-damage-deposit).
