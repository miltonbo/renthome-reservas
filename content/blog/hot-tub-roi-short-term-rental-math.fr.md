...
locale: fr
title: "ROI d'un spa pour la location courte durée : la rentabilité en 28 mois"
excerpt: "Un spa ajoute 35–60 $ par nuit et 8–12 points d'occupation en climat froid. L'installation s'amortit en 22–34 mois — et jamais en climat chaud."
status: published
tags:
  - airbnb:Airbnb
...
- Un spa ajoute en moyenne **35 à 60 $ par nuit** par rapport à une annonce comparable.
- Il fait gagner **8 à 12 points d'occupation** en climat froid et en intersaison ; **2 à 4 points** en climat chaud.
- L'**installation clés en main coûte 4 000 à 8 000 $** pour un modèle plug-and-play hors-sol ; **10 000 à 22 000 $** pour un spa encastré avec travaux de terrasse.
- Le **coût d'exploitation annuel est de 900 à 1 800 $** : électricité (350–700 $), produits (150–300 $), filtre et couverture (100–250 $), eau et menue maintenance (200–450 $).
- L'amortissement est de **22 à 34 mois** pour les chalets de montagne et les maisons au bord d'un lac ; **jamais** pour les biens balnéaires, le sud de l'Espagne, la Floride ou la plupart des îles grecques.
- Le spa ajoute **deux nouveaux risques d'avis négatif** — plaintes sur l'eau, plaintes sur le bruit — qui reprennent ensemble la moitié de la prime brute en remboursements et perte de note.
- Pour un hôte qui gère 1 à 4 biens, le bon choix est un **modèle plug-and-play 110 V**, pas un 220 V câblé. L'installation prend une journée, pas trois semaines.
...
Pour la photographie d'ensemble de l'opérationnel une fois le spa en service, voyez [la rémunération du ménage en location courte durée](/blog/cleaner-pay-short-term-rental) — l'agent d'entretien intègre désormais la préparation du spa dans le forfait ménage, ce qui déplace la rémunération de 10 à 20 $ par rotation.

## Quand le calcul dit non

Avant l'installation, trois combinaisons qui n'atteignent presque jamais le seuil de rentabilité :

1. **Biens balnéaires en climat chaud** — îles grecques, sud de l'Espagne, Floride, Costa Rica, côte vietnamienne. Le saut d'occupation s'effondre et l'exploitation coûte plus cher.
2. **Biens avec une piscine déjà sur place** — la piscine occupe déjà le créneau « équipement eau » dans la recherche du voyageur. Le spa devient un accessoire à 1 300 $ par an.
3. **Appartements urbains** — presque aucun n'a la terrasse, la tolérance du voisinage ou la voie de permis nécessaires. Quelques exceptions sur des appartements de villes de montagne avec accès toit-terrasse sur les marchés alpins, où le calcul redevient intéressant.
