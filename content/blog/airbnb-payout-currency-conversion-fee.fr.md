...
locale: fr
title: "Frais de change Airbnb : les 3 % cachés sur vos versements"
excerpt: Prix dans une devise, compte dans une autre ? Airbnb et Booking.com glissent ~3 % dans chaque versement converti. Le vrai calcul, et comment arrêter de payer.
status: published
tags:
  - airbnb:Airbnb
...
- Le taux de versement d'Airbnb est ~3 % sous l'interbancaire quand les devises diffèrent.
- Les frais sont noyés dans le taux — pas de ligne, pas de reçu, invisibles des années.
- Sur 30 000 € de versements par an, c'est environ 900 € donnés pour rien.
- Solution la moins chère : prix et versement dans la *même* devise — aucune conversion.
- Impossible ? Recevez dans la devise de l'annonce via Wise (~0,5 %), changez vous-même.
- Booking.com cache la même marge dans les cartes virtuelles et ses versements.
...
Pour voir comment cela s'empile avec les *autres* fuites invisibles d'un versement, rappelez-vous que le timing de l'argent compte autant que le taux — voir [le timing des versements Airbnb et Booking.com](/blog/airbnb-booking-com-payout-timing), le volet trésorerie du même relevé.
...
1. Ouvrez votre dernier versement. Notez le **montant reçu** et la **devise**.
2. Retrouvez le **total de la réservation** correspondant à ce versement, dans la **devise de l'annonce**, moins les frais hôte de la plateforme.
3. Cherchez le **taux interbancaire** de cette paire à la date du versement. Multipliez le total net de la réservation par ce taux. C'est ce que vous *auriez dû* recevoir.
