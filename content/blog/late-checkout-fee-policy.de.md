...
locale: de
title: "Später-Auscheck-Gebühr: was berechnen, was Hosts wirklich kassieren"
excerpt: Durchgerechnete Später-Auscheck-Gebühren auf Airbnb, Booking.com und Vrbo — stündlich gegen halber Tag, wann die erste Stunde gratis sinnvoll ist, und die Same-Day-Anreise-Klippe.
status: published
tags:
...
- Eine Später-Auscheck-Gebühr ist zwei Dinge: ein Preis *und* eine Erlaubnis. Die meisten Hosts bepreisen nur.
- **20–40 $ pro Stunde nach 11:00**, gedeckelt bei einer halben Nacht. Darüber einfach die ganze Extra-Nacht berechnen.
- **Erste 60 Minuten gratis** bei Anreise nach 16:00 — rettet öfter eine Superhost-Bewertung, als die Reinigungskraft eine Stunde kostet.
- Wenn der nächste Gast Same-Day vor 14:00 anreist, **muss spät ausgecheckt abgelehnt werden**. Keine Gebühr deckt einen verpassten Wechsel.
- Eine im Listing stehende „50-$-Später-Auscheck-Gebühr", inkonsistent durchgesetzt, ist schlimmer als keine Politik. Inkonsistenz taucht in Bewertungen auf.
- Booking.com rechnet späte Gebühren nicht über die Plattform ab — über Stripe einziehen, das „Extra-Charge"-Tool der Plattform oder bar. Nicht als sicheren Umsatz einplanen.
...
| Objekttyp | Reinigungszeit | Puffer nötig (inkl. Anfahrt) |
|---|---|---|
| Studio, 1 Reinigungskraft | 1,5 h | 2,5 h |
| 1-Zimmer, 1 Reinigungskraft | 2 h | 3 h |
| 2-Zimmer, 1 Reinigungskraft | 3 h | 4 h |
| 3-Zimmer+, 1 Reinigungskraft | 4 h | 5 h |
| 2-Zimmer, 2 Reinigungskräfte | 1,75 h | 3 h |
...
Wenn Ihr Kalender Same-Day-Anreisen nicht auf einen Blick zeigt, ist das das größere Problem. Eine Später-Auscheck-Anfrage soll 90 Sekunden zu evaluieren sein. Dauert es 10 Minuten, weil Sie sich in drei Plattformen einloggen müssen, sagen Sie entweder ja, wenn Sie nein sagen sollten, oder nein, wenn Sie hätten ja sagen können — beides bluten Umsatz. (Zur Kalender-Seite: [airbnb-booking-calendar-sync-free](/blog/airbnb-booking-calendar-sync-free) deckt iCal-Mechanik; die Puffer-Seite in [cleaning-buffer-days](/blog/cleaning-buffer-days).)
