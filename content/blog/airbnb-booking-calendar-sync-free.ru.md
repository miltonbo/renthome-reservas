...
- Бесплатный промежуточный слой (open-source [RentHome Departamentos](/onboard) или самописный cron) опрашивает чаще, но ускорить опрос на стороне самой площадки он не может.
...
2. **Бесплатный промежуточный слой.** Маленький open-source инструмент стоит между площадками. И Airbnb, и Booking импортируют из него; он импортирует из них. На каждую площадку остаётся по одной ссылке, добавление третьей — это две новые ссылки, а не четыре. Опрос на промежуточном слое можно делать гораздо чаще, чем у самих площадок: инстанс [RentHome Departamentos](/onboard) опрашивает раз в 10 минут. Тоже бесплатно; можно поднять у себя на дроплете за $4 или использовать хостед-версию.
...
Промежуточный слой (вариант 2) лечит половину проблемы. Наш хостед-инстанс опрашивает источники раз в 10 минут — то есть RentHome Departamentos узнаёт о новом бронировании на Airbnb в течение десяти минут. Но он **не** ускоряет опрос самого Booking.com *в адрес RentHome Departamentos*. Booking всё равно берёт свои 2–6 часов.
...
Да. Нажмите **Сбросить ссылку** в панели синхронизации Airbnb — старая URL мгновенно перестаёт работать. Делайте так сразу, как только заподозрили, что ссылку увидел кто-то лишний: публичный Slack, скриншот, ответ на форуме. RentHome Departamentos по той же причине умеет ротировать свой исходящий фид по запросу.
...
**Сколько стоит RentHome Departamentos?**
