...
locale: de
title: "Airbnb-Sofortbuchung vs. Buchungsanfrage: was sich wirklich rechnet"
excerpt: Was die Sofortbuchung Sie tatsächlich an Buchungen kostet, die vier Gastsignale, bei denen sich die Buchungsanfrage lohnt, und die Tabelle zur Entscheidung.
status: published
tags:
  - airbnb:Airbnb
...
- Die Sofortbuchung abzuschalten kostet ein Inserat **8 bis 18 % seiner monatlichen Buchungen** — allein durch die Unterdrückung im Such-Ranking. Der Filter „Sofortbuchung" ist in der Gastsuche standardmäßig aktiv und blendet Sie aus den meisten Sessions aus.
- Die Buchungsanfrage filtert exakt vier Gasttypen: **Erstreisende ohne Bewertungen, kurzfristige Wochenend-Bucher, Profile ohne ID-Verifizierung und Haustier-Grenzfälle**. Bei den übrigen 90 % der Gäste nützt sie nichts.
- Die Gewinnschwelle liegt bei rund **2 problematischen Aufenthalten pro 10 Buchungen**. Wenn von Ihren letzten 50 Aufenthalten weniger als 10 schwierig waren, ist die Sofortbuchung die richtige Einstellung.
- **Der Kompromiss, über den selten geschrieben wird**: Sofortbuchung an, dabei die vier Filter unter „Anforderungen an Gäste" voll ausreizen. Gleicher Ranking-Boost, zwei Drittel des Screening-Nutzens.
- Die 24-Stunden-Uhr startet in dem Moment, in dem Airbnb die Anfrage zustellt — **nicht, wenn Sie sie lesen**. Eine verspätete Antwort kostet den Superhost-Status, nicht eine abgelehnte Buchung.
...
Sofortbuchungs-Äquivalent: keines sauber. Ist die „Keine Haustiere"-Regel strukturell — Hausordnung, Allergien —, gewinnt die Buchungsanfrage für dieses Signal. Ist sie Präferenz, akzeptieren Sie den Hund und nehmen 50 $ Haustiergebühr. Die Dollar-Rechnung dafür steht in [Haustiergebühr-Mathematik für Kurzzeitvermietungen](/blog/pet-fee-math-short-term-rental).
...
| Einstellung | Buchungen/Monat | Verlust durch Screening | Verlust durch schlechte Gäste | Netto-Buchungen | Netto-Umsatz |
|---|---|---|---|---|---|
| Sofortbuchung AN, ohne Anforderungen | 10,0 | 0,0 | 0,8 | 9,2 | 2 484 $ |
| Sofortbuchung AN, alle Anforderungen | 9,8 | 0,2 | 0,3 | 9,3 | 2 511 $ |
| Buchungsanfrage, manuelle Prüfung | 8,2 | 1,8 | 0,1 | 8,1 | 2 187 $ |
...
Außerhalb dieser zwei Fälle schlägt Sofortbuchung plus volle Anforderungen jede andere Konfiguration in der Tabelle. Verwandte Lektüre: [Doppelbuchungen vermeiden](/blog/avoiding-double-bookings) und [Airbnb- und Booking.com-Kalender synchronisieren](/blog/airbnb-booking-calendar-sync-free).
