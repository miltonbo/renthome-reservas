...
locale: de
title: "Booking.com Preferred Partner: wann sich die +2 % Provision lohnen"
excerpt: Durchgerechnet: Das Preferred-Partner-Abzeichen von Booking.com — die +2 % Provision als Steuer, die zwei Stufen und warum es sich nur bei freien Nächten lohnt.
status: published
tags:
...
- Preferred Partner kostet **~2 PP mehr Provision** (15 % → 17 %) für besseres Ranking plus Abzeichen.
- **Preferred Plus** ist die höhere Stufe — mehr Sichtbarkeit, **~3 PP+** Provision, strengere Regeln.
- Anders als Genius trifft die Steuer Ihren **gesamten** Umsatz, nicht nur einen Teil.
- Die Schwelle ist niedrig: ein Umsatzplus von **~3 %** deckt die 2 PP. Genius braucht ~12 %.
- Der Haken: Das Abzeichen bringt nur mehr Buchungen, wenn es **freie Nächte** zu füllen gibt.
- Über **~85 % Auslastung** ist es ein glattes 2-PP-Geschenk an Booking.com — abmelden.
...
Hosts werfen Preferred und [Genius](/blog/booking-com-genius-levels-math) in einen Topf, weil beide „zahle Booking.com mehr für Sichtbarkeit" bedeuten. Es sind nicht dieselben Hebel, und der Unterschied entscheidet, zu welchem Sie greifen sollten.
...
1. **Annehmen, wenn Ihr Kalender 30 Tage im Voraus unter ~75 % gebucht ist.** Sie haben freie Nächte, die Schwelle liegt bei ~3 %, und das Abzeichen nimmt sie locker. Das trifft auf die meisten Objekte die meiste Zeit zu.
2. **Ablehnen oder abmelden über ~85 % Auslastung.** Es gibt nichts zu füllen, also sind die 2 PP reine Kosten. Wenn Sie dauerhaft so voll sind, ist Ihr Problem ein zu niedriger Preis, nicht fehlende Sichtbarkeit; erhöhen Sie die Raten, bevor Sie für ein Abzeichen zahlen.
...
Nein. Es ändert nur den Provisionssatz, den Booking.com abzieht. Ihr Auszahlungsplan richtet sich nach Ihren Auszahlungseinstellungen, nicht nach dem Programm — wie das funktioniert, lesen Sie unter [Auszahlungsfristen bei Booking.com](/blog/airbnb-booking-com-payout-timing).
