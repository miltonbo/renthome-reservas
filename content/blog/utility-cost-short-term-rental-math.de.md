...
locale: de
title: "Nebenkosten pro Nacht in der Kurzzeitvermietung: eine Beispielrechnung"
excerpt: Was Strom, Heizung, Wasser und Internet pro gebuchter Nacht wirklich kosten — aufgeschlüsselt über drei Jahreszeiten, und warum die Klimaanlage bei offenem Fenster die ganze Rechnung sprengt.
status: published
tags:
...
- Nebenkosten liegen bei **5–10 $ pro belegter Nacht** für eine 1-Zimmer — kaum jemand rechnet sie pro Buchung.
- Es ist ein **Hybridkosten**: Internet ist pro Nacht fix, Heizung und Wasser steigen mit der Auslastung.
- Die **Gästeverhaltens-Steuer** ist real: Ein Gast zahlt keine Rechnung, also spart er nicht.
- Heizen und Kühlen sind die Schwankungsposition: Sommer und Winter können die Zahl **verdoppeln**.
- Internet wirkt billig, bis die Auslastung fällt — fixe 45 $/Mon. kosten mehr pro *gebuchter* Nacht.
- Aufs Jahr läuft eine einzelne 1-Zimmer auf **~1.500–1.800 $**, drei Objekte auf ~4.800 $.
- Ein smartes Thermostat für 120 $ macht sich oft in einem Sommer bezahlt.
