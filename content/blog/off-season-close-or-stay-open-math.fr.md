...
locale: fr
title: "Basse saison : fermer l'annonce ou rester ouvert ?"
excerpt: "Fermer n'arrête ni l'assurance, ni l'internet, ni les abonnements — seulement les revenus. Le calcul de marge sur coûts variables, nuit par nuit."
status: published
tags:
...
- Fermer n'arrête pas les charges fixes. Ça n'arrête que les recettes.
- La décision se prend en marge par nuit, pas en résultat mensuel.
- Une rotation coûte environ 66 $. Sur deux nuits, ça fait 42 $ la nuit.
- Seuil de rentabilité : 77 $ pour une nuit, 19 $ pour une semaine.
- Montez la durée minimale de séjour au lieu de fermer le calendrier.
- Vérifiez la clause d'inoccupation : souvent 30 à 60 jours.
- Un quota légal de nuits par an : le seul vrai argument pour fermer.
...
1. **Ce bien vaut-il la peine d'être détenu ?** Coût complet, horizon d'un an. Toutes les lignes comptent.
2. **Dois-je vendre une nuit à 70 $ en février ?** Coûts variables seulement. La plupart des lignes ne comptent pas du tout.
...
- Femme ou homme de ménage : 45–70 $ pour un deux-pièces, plus s'il y a de la route. Le détail dans [ce que coûte vraiment un ménage](/blog/cleaner-pay-short-term-rental).
- Blanchisserie : environ 3,50 $ chez vous, 8–14 $ en pressing — le [calcul complet par rotation](/blog/short-term-rental-laundry-cost-math).
- Consommables : 6–9 $ de café, papier, savon et le reste, voir le [coût par séjour](/blog/consumables-cost-per-stay-math).
...
- Chauffage et eau chaude au-dessus du niveau hors-gel : 3–8 $ selon le climat et l'isolation. Les valeurs à la nuit sont dans le [calcul des charges](/blog/utility-cost-short-term-rental-math).
...
**Proportionnelles — un pourcentage de ce que vous facturez.** Airbnb prélève environ 3 % en frais hôte uniquement, et [à peu près 3 % de votre côté en frais partagés](/blog/airbnb-host-only-fee-vs-split-fee-math). Booking.com prend 15–18 %, avec la TVA sur la commission en plus dans la majorité de l'UE.

Et voici ce qui n'est **pas** un coût variable, aussi douloureux soit-il à payer : assurance, crédit ou loyer, internet, abonnements aux fournisseurs d'énergie, taxes d'enregistrement, amortissements, votre abonnement de tarification dynamique et la [provision pour travaux](/blog/maintenance-reserve-short-term-rental-math) que vous alimentez tous les mois. Chacune de ces lignes est identique que le calendrier soit plein ou vide.
...
Le levier de la basse saison, c'est donc la durée minimale de séjour, pas le bouton « fermer ». Passez le [séjour minimum](/blog/minimum-night-stay-math) de une à trois nuits sur vos mois creux : les réservations qui vous coûtaient de l'argent cessent simplement d'arriver, sans que vous perdiez celles qui vous en rapportaient.
...
Et avant de partir sur un trimestre noir, cherchez dans votre contrat la **clause d'inoccupation**. Beaucoup de polices suspendent ou réduisent la garantie après 30 ou 60 jours consécutifs sans occupation, et le sinistre qui saute sur cette clause est presque toujours le même : une canalisation qui a gelé et cédé en semaine dix, découverte en semaine douze. [Les contrats meublé de tourisme diffèrent beaucoup sur ce point](/blog/short-term-rental-insurance-cost) — certains acceptent une visite hebdomadaire documentée comme une occupation, d'autres non. C'est un coup de fil de cinq minutes, et c'est la différence entre une réparation à 400 $ et une à 14 000 $.
