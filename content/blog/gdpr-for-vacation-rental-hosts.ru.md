...
- Кто ещё: площадки (Airbnb, Booking) и инструменты, которыми вы пользуетесь ([RentHome Departamentos](/onboard), если используете).
...
- Ваш **PMS или sync-инструмент**. Если вы пользуетесь Hostaway, Lodgify, Smoobu или RentHome Departamentos — это субпроцессор. Перечислите.
