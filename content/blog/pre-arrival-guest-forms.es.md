...
locale: es
title: "Formulario previo al check-in: qué pedir, cuándo enviar y cómo subir el ratio"
excerpt: Guía campo por campo del formulario previo a la llegada para Anfitriones de alquiler corto. Qué preguntar, qué saltar y cómo pasar del 90 % de cumplimentación.
status: published
tags:
...
- Un formulario previo debe tener **5–7 campos**, no 12. Cada extra corta cumplimentación ~4–5 puntos.
- Mándalo **4 días antes de la llegada**, no al reservar. Los del momento de reserva se ignoran; el Huésped está emocionado con el viaje, no con el papeleo.
- Pide solo lo que **vas a usar esta estancia**. ID y hora de llegada, sí. Preferencia de fumar y dieta, no.
- Un único recordatorio a T-1 día sube cumplimentación del 60–65 % al 88–92 %. Dos recordatorios molestan más de lo que convierten.
- Auto-incluye el código de la puerta solo **después** de enviar el formulario. Esta es la palanca más grande —convierte el formulario de tarea en llave—.
...
Para profundidad sobre cómo Airbnb y Booking.com surfacean chat vs email, intervalos de refresco y dónde aterriza el enlace, mira [cómo sincronizar Airbnb y Booking.com en un sitio](/blog/airbnb-booking-calendar-sync-free).
...
El cuadro completo de lo que debes a Huéspedes en datos —aviso, base legal, retención, proceso de borrado— es un post aparte: [RGPD para Anfitriones](/blog/gdpr-for-vacation-rental-hosts). El formulario previo es el momento en que la mayoría recoge dato personal por primera vez; trátalo como el evento regulado que es.
