...
locale: es
title: "RGPD para Anfitriones de alquiler corto: lo que de verdad tienes que hacer"
excerpt: RGPD práctico para Anfitriones de alquiler corto. Cinco acciones concretas esta semana: aviso de privacidad, base legal, retención, encargados, borrado.
status: draft
tags:
  - gdpr:GDPR
...
- El RGPD se te aplica desde el momento en que aceptas una reserva de alguien en la UE, aunque tu Alojamiento esté fuera. El alcance extraterritorial es real.
- Necesitas un aviso de privacidad que el Huésped pueda leer antes de compartir su pasaporte. Una frase al reservar, texto completo en una página /privacy.
- Tu base legal casi siempre es **contrato** más **obligación legal** para el registro de Huéspedes. No consentimiento.
- Elige un periodo de retención. Anótalo. Cúmplelo. «Hasta que lo borre» no es un periodo.
- Un Huésped puede pedirte borrar sus datos. Necesitas un flujo. No una herramienta perfecta, un flujo.

## ¿Se me aplica el RGPD?

Si tu Alojamiento está en la UE y lo alquilas: sí.

Si está fuera de la UE pero aceptas Huéspedes de países UE: también, por el alcance extraterritorial del RGPD. El artículo 3.2 extiende el reglamento a cualquier responsable que «trate datos personales de interesados en la Unión» al ofrecerles bienes o servicios. Un anuncio de Airbnb en Tashkent que recibe una reserva de un Huésped de Berlín está, sobre el papel, tratando datos de un sujeto UE y por tanto cubierto. La visión general de la Comisión Europea sobre [a quién aplica](https://commission.europa.eu/law/law-topic/data-protection/reform/rules-business-and-organisations/application-regulation/who-does-data-protection-law-apply_en) es clara; el [Comité Europeo de Protección de Datos](https://www.edpb.europa.eu/edpb_en) publica directrices dirigidas a responsables fuera de la UE.
...
2. **Una página completa en /privacy.** Lista las categorías de datos, el propósito, la base legal, el periodo de retención y el contacto para borrado. Sin jerga legal. El lenguaje claro gana porque las autoridades de control [ahora lo prefieren explícitamente](https://www.edpb.europa.eu/our-work-tools/our-documents/guidelines/guidelines-052020-consent-under-regulation-2016679_en).

Nuestra [página /privacy](/privacy) es el ejemplo que creo que los Anfitriones pequeños pueden copiar casi literalmente. Tiene unas 600 palabras. Las secciones clave:
...
Punto adyacente pequeño: [el módulo de limpieza en una propiedad pequeña](/blog/cleaning-schedule-automation) suele meter otro encargado (la app del limpiador, si la usas). Los limpiadores ven nombres de Huésped y horas de check-in, lo que cuenta como dato personal. Menciónalos también.
...
**Anfitriono fuera de la UE. ¿De verdad lo necesito?**
Estrictamente, sí, en cuanto aceptas un Huésped UE. Prácticamente, el riesgo de sanción a un Anfitrión único fuera de la UE es casi cero. El riesgo reputacional y de relación con la plataforma es real. Trátalo como higiene de plataforma, no como exposición legal.

**¿Puedo usar la política de privacidad de Airbnb?**
No. Airbnb es responsable de los datos que ellos guardan; tú eres responsable de los datos que guardas separadamente (copias de pasaporte, mensajes directos, notas offline). Cada responsable necesita su propio aviso.

**¿Necesito Delegado de Protección de Datos?**
Para Anfitrión de 1 a 10 propiedades, casi seguro no. El artículo 37 lista cuándo es obligatorio: tratamiento a gran escala de categorías especiales, autoridades públicas, monitorización sistemática a gran escala. Nada de eso aplica.

**¿Y las cookies en mi web?**
Si tienes una landing personal o web pequeña, solo necesitas banner de cookies si pones cookies para analítica, publicidad o embeds de terceros. Una página estática sin nada de eso no necesita banner. Una con Google Analytics necesita uno con consentimiento granular.

**¿Puedo guardar datos de Huéspedes en Google Drive?**
Técnicamente sí si listas a Google como encargado y aplicas las mismas reglas de retención. En la práctica yo no lo haría. Drive es demasiado fácil de sobrecompartir. Usa una carpeta cifrable en reposo y con borrado automático de archivos viejos.

**¿Qué pasa si recibo una queja?**
La mayoría de autoridades te dan oportunidad de arreglar antes de multar. No buscan hacer ejemplo de Anfitriones pequeños. Una respuesta educada en la ventana de 30 días, evidencia de que tienes aviso y política de retención, y la multa normalmente no llega. Los multados son los que ignoran la carta.
