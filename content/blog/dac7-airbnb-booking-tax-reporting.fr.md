...
locale: fr
title: "DAC7 : Airbnb et Booking.com déclarent vos revenus au fisc"
excerpt: Depuis 2023, Airbnb et Booking.com transmettent les revenus de chaque hôte au fisc au titre de DAC7 — et la location n'a aucun seuil de tolérance. Voici ce qui part exactement.
status: published
tags:
  - airbnb:Airbnb
...
- DAC7 s'applique dans l'UE depuis le 1er janvier 2023 ; premières déclarations en janvier 2024.
- Le seuil « 30 ventes ou 2 000 € » vise la vente de biens, pas la location.
- Pour la location, aucun seuil de tolérance : une réservation suffit à vous rendre déclarable.
- La plateforme transmet nom, numéro fiscal, IBAN, adresse du bien et chiffre d'affaires.
- Pas de numéro fiscal après deux relances et 60 jours ? Vos versements sont gelés.
- Hôtes aux États-Unis : le seuil du 1099-K est revenu à 20 000 $ et 200 réservations.
...
1. **Les États fédérés fixent leurs propres seuils, plus bas.** Plusieurs imposent un 1099-K bien en deçà de la barre fédérale — certains dès 600 $, d'autres dès 1 000 $. Là où vous louez compte.
2. **Pas de formulaire ne veut pas dire pas d'impôt.** Le 1099-K est un déclencheur de déclaration, pas l'impôt lui-même. Chaque dollar de revenu locatif est déclarable, formulaire ou non. L'absence de formulaire n'efface pas l'obligation — elle retire seulement le recoupement automatique de l'IRS.
3. **Sans W-9, la retenue s'applique.** Si Airbnb n'a pas d'informations fiscales valides, il peut appliquer **jusqu'à 24 % de retenue (backup withholding)** sur vos versements, quel que soit le seuil. Même logique que DAC7 : remplir le formulaire, ou voir son argent retenu.
...
Un rapprochement concret qui mord les hôtes de l'UE : la taxe de séjour. Sur certaines plateformes et dans certaines villes, la plateforme la collecte auprès du voyageur et la reverse directement — apparaîtra-t-elle dans votre chiffre DAC7 ? Cela dépend de la façon dont elle la classe. Si votre CA déclaré et le CA DAC7 diffèrent de montants par nuit suspectement ronds, la taxe de séjour est en général la coupable. Qui la collecte et la reverse sur chaque plateforme, nous l'avons disséqué dans [qui collecte la taxe de séjour sur Airbnb, Booking.com et Vrbo](/blog/tourist-tax-airbnb-booking-vrbo) — à lire avant de conclure à une erreur.

Les hôtes qui gèrent bien cela ne sont pas ceux aux montages malins. Ce sont ceux qui, le jour de la demande de numéro fiscal, le collent dans le formulaire, et qui tiennent un tableau « une réservation, une ligne » déjà aligné sur ce que la plateforme déclarera. Si vous voulez que ce registre se construise et se rapproche automatiquement de vos calendriers synchronisés, c'est une partie de ce que fait [RentHome Departamentos](/onboard) : un seul endroit où réservations, versements et chiffres vus par le fisc coïncident.
