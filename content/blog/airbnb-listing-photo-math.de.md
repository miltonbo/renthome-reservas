...
locale: de
title: "Fotos im Airbnb-Inserat: Anzahl, Reihenfolge und welches Bild den Klick verdient"
excerpt: Das Titelbild entscheidet 70–80 % der Klicks in der Trefferliste. Bilder 2–7 entscheiden über das Speichern in die Merkliste. Über 25 Fotos wird die Kurve flach. Drei Inserate im Audit und die Reihenfolge beim Shooting.
status: published
tags:
  - airbnb:Airbnb
...
- Das **Titelbild entscheidet 70–80 % der Klicks** in den Airbnb-Suchergebnissen. Nichts anderes auf der Karte arbeitet so hart.
- Bilder **2 bis 7** entscheiden über das Speichern in die Merkliste und die Buchungsanfrage — Gäste scrollen die erste Reihe und hören dann auf.
- Ab etwa **25 Fotos** wird die Buchungskurve flach. Weitere Bilder erhöhen das Gewicht des Karussells, nicht die Buchungen.
- Das Airbnb-**Minimum sind 5 Bilder**; die praktische Untergrenze liegt bei **15** — alles darunter wirkt halbfertig und wird entsprechend gerankt.
- Booking.com zählt **die Bildabdeckung als Eingabe für den Property Score**. Inserate mit weniger als 20 Bildern stehen messbar weiter unten in der Sortierung.
- Der wirkungsvollste Einzelschritt: **das Titelbild austauschen** — jährlich neu fotografieren und nach jedem Anstrich im gezeigten Raum.
- Die meisten Inserate ranken zu niedrig wegen der **Reihenfolge**, nicht wegen der Bildqualität. Erst sortieren, dann neu fotografieren.
...
| Anzahl Fotos | Relative Buchungsrate |
| --- | --- |
...
| Position | Was hingehört | Warum |
| --- | --- | --- |
| 1 (Titelbild) | Bester Raum, beste Stunde, Tiefe und Detail | Entscheidet den Klick |
| 2 | Schlafzimmer — weit, gemachtes Bett, Tageslicht | Beantwortet „wo schlafe ich" |
| 3 | Küche — weit, freie Arbeitsfläche | Beantwortet „kann ich Kaffee kochen" |
| 4 | Bad — weit, sauber, ohne Krimskrams | Das am meisten gefürchtete Foto; früh zeigen, um Sorge zu entschärfen |
| 5–7 | Zweiter Wohnzimmerwinkel, zweiter Schlafzimmerwinkel, Blick aus dem Fenster | Verkauft den Raum |
| 8–12 | Detailaufnahmen — Arbeitsplatz, Kaffee-Setup, Balkon, Esstisch | Verkauft den Lifestyle |
| 13–18 | Hauseingang, Treppenhaus, Straßenzug, nahegelegenes Café | Verkauft die Lage |
| 19–22 | Grundriss, Geräte (Waschmaschine, Trockner, Klimaanlage), Nahaufnahme der Bettwäsche | Verkauft den Betrieb |
...
Zur operativen Seite des Shootings — wann, wer, was es kostet — siehe [Wäsche-Inventar für Ferienwohnungen](/blog/linen-inventory-short-term-rental), wo die Detailgrundlage, die man auf Fotos sieht, im Vordergrund steht.
