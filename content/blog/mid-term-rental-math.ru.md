...
5. **Ведите оба режима в одном месте.** Объект, переведённый на среднесрок, всё ещё держит посуточный листинг тёплым на месяцы между долгими гостями. Один календарь, одна цифра загрузки, оба режима цен видны разом — ровно для этого и нужен [RentHome Departamentos](/onboard).
